...
$__global_Data_Time_Component_Gen_genHour = ($GLOBALS['Data_Time_Component_Gen_genHour'] ?? \Data\Time\Component\Gen\phpurs_eval_thunk('Data_Time_Component_Gen_genHour'));
$__global_Data_Time_Component_Gen_genMinute = ($GLOBALS['Data_Time_Component_Gen_genMinute'] ?? \Data\Time\Component\Gen\phpurs_eval_thunk('Data_Time_Component_Gen_genMinute'));
$__global_Data_Time_Component_Gen_genSecond = ($GLOBALS['Data_Time_Component_Gen_genSecond'] ?? \Data\Time\Component\Gen\phpurs_eval_thunk('Data_Time_Component_Gen_genSecond'));
$__global_Data_Time_Component_Gen_genMillisecond = ($GLOBALS['Data_Time_Component_Gen_genMillisecond'] ?? \Data\Time\Component\Gen\phpurs_eval_thunk('Data_Time_Component_Gen_genMillisecond'));
$Apply0 = (((((($dictMonadGen)->Monad0)($__global_Prim_undefined))->Bind1)($__global_Prim_undefined))->Apply0)($__global_Prim_undefined);
$apply = ($Apply0)->apply;
    $__res = ($apply)(($apply)(($apply)((((($Apply0)->Functor0)($__global_Prim_undefined))->map)((function() {
  ...
  return $__fn;
})(), ($__global_Data_Time_Component_Gen_genHour)($dictMonadGen)), ($__global_Data_Time_Component_Gen_genMinute)($dictMonadGen)), ($__global_Data_Time_Component_Gen_genSecond)($dictMonadGen)), ($__global_Data_Time_Component_Gen_genMillisecond)($dictMonadGen));
