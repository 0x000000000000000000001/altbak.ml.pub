...
throw new \Exception("Pattern match failure");
  ...
  return $__fn;
      ...
      case 'Data_Semigroup_Last_eq1Last': $v = (object)["eq1" => (function() {
  ...
  return $__fn;
      ...
      case 'Data_Semigroup_Last_ord1Last': $v = (object)["compare1" => (function() {
...
$__global_Data_Semigroup_Last_applyLast = ($GLOBALS['Data_Semigroup_Last_applyLast'] ?? \Data\Semigroup\Last\phpurs_eval_thunk('Data_Semigroup_Last_applyLast'));
  ...
  return $__fn;
      ...
      case 'Data_Semigroup_Last_applicativeLast': $v = (object)["pure" => ($GLOBALS['Data_Semigroup_Last_Last'] ?? \Data\Semigroup\Last\phpurs_eval_thunk('Data_Semigroup_Last_Last')), "Apply0" => (function() {
  $__fn = function($__dollar____unused) use (&$__fn) {
  $__num = func_num_args();
  if ($__num < 1) {
    return phpurs_curry_fallback($__fn, func_get_args(), 1);
...
$__global_Data_Semigroup_Last_applyLast = ($GLOBALS['Data_Semigroup_Last_applyLast'] ?? \Data\Semigroup\Last\phpurs_eval_thunk('Data_Semigroup_Last_applyLast'));
  ...
  return $__fn;
      ...
      case 'Data_Semigroup_Last_monadLast': $v = (object)["Applicative0" => (function() {
  $__fn = function($__dollar____unused) use (&$__fn) {
  $__num = func_num_args();
  if ($__num < 1) {
    return phpurs_curry_fallback($__fn, func_get_args(), 1);
