...
$foldableEnvT1 = ($__global_Control_Comonad_Env_Trans_foldableEnvT)((($dictTraversable)->Foldable1)($__global_Prim_undefined));
    $__res = (object)["sequence" => (function() use ($__global_Prim_undefined, $sequence, $__global_Control_Comonad_Env_Trans_map, $__global_Control_Comonad_Env_Trans_EnvT) {
  $__fn = function($dictApplicative) use ($__global_Prim_undefined, $sequence, $__global_Control_Comonad_Env_Trans_map, $__global_Control_Comonad_Env_Trans_EnvT, &$__fn) {
  $__num = func_num_args();
  if ($__num < 1) {
    return phpurs_curry_fallback($__fn, func_get_args(), 1);
  }
...
break;
  ...
  return $__fn;
})(), "traverse" => (function() use ($__global_Prim_undefined, $traverse, $__global_Control_Comonad_Env_Trans_map, $__global_Control_Comonad_Env_Trans_EnvT) {
  $__fn = function($dictApplicative) use ($__global_Prim_undefined, $traverse, $__global_Control_Comonad_Env_Trans_map, $__global_Control_Comonad_Env_Trans_EnvT, &$__fn) {
  $__num = func_num_args();
  if ($__num < 1) {
    return phpurs_curry_fallback($__fn, func_get_args(), 1);
  }
...
$traversableEnvT1 = ($__global_Control_Comonad_Env_Trans_traversableEnvT)((($dictTraversableWithIndex)->Traversable2)($__global_Prim_undefined));
    $__res = (object)["traverseWithIndex" => (function() use ($__global_Prim_undefined, $traverseWithIndex, $__global_Control_Comonad_Env_Trans_map, $__global_Control_Comonad_Env_Trans_EnvT) {
  $__fn = function($dictApplicative) use ($__global_Prim_undefined, $traverseWithIndex, $__global_Control_Comonad_Env_Trans_map, $__global_Control_Comonad_Env_Trans_EnvT, &$__fn) {
  $__num = func_num_args();
  if ($__num < 1) {
    return phpurs_curry_fallback($__fn, func_get_args(), 1);
  }
