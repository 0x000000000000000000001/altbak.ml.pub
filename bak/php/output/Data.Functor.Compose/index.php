...
$eq1 = ($dictEq1)->eq1;
    $__res = (function() use ($__global_Data_Functor_App_eqApp, $eq1, $__global_Unsafe_Coerce_unsafeCoerce) {
  $__fn = function($dictEq11) use ($__global_Data_Functor_App_eqApp, $eq1, $__global_Unsafe_Coerce_unsafeCoerce, &$__fn) {
  $__num = func_num_args();
  if ($__num < 1) {
    return phpurs_curry_fallback($__fn, func_get_args(), 1);
  }
...
$eqCompose1 = ($__global_Data_Functor_Compose_eqCompose)((($dictOrd1)->Eq10)($__global_Prim_undefined));
    $__res = (function() use ($__global_Data_Functor_App_ordApp, $eqCompose1, $__global_Prim_undefined, $compare1, $__global_Unsafe_Coerce_unsafeCoerce) {
  $__fn = function($dictOrd11) use ($__global_Data_Functor_App_ordApp, $eqCompose1, $__global_Prim_undefined, $compare1, $__global_Unsafe_Coerce_unsafeCoerce, &$__fn) {
  $__num = func_num_args();
  if ($__num < 1) {
    return phpurs_curry_fallback($__fn, func_get_args(), 1);
  }
...
$eqCompose2 = ($eqCompose1)($dictEq11);
    $__res = (object)["eq1" => (function() use ($eqCompose2) {
...
$eq1Compose1 = ($__global_Data_Functor_Compose_eq1Compose)((($dictOrd1)->Eq10)($__global_Prim_undefined));
    $__res = (function() use ($ordCompose1, $eq1Compose1, $__global_Prim_undefined) {
  $__fn = function($dictOrd11) use ($ordCompose1, $eq1Compose1, $__global_Prim_undefined, &$__fn) {
  $__num = func_num_args();
  if ($__num < 1) {
    return phpurs_curry_fallback($__fn, func_get_args(), 1);
  }
...
$eq1Compose2 = ($eq1Compose1)((($dictOrd11)->Eq10)($__global_Prim_undefined));
    $__res = (object)["compare1" => (function() use ($ordCompose2) {
...
$applyCompose2 = ($applyCompose1)((($dictApplicative1)->Apply0)($__global_Prim_undefined));
    $__res = (object)["pure" => ($__global_Data_Functor_Compose_compose)($__global_Data_Functor_Compose_Compose, ($__global_Data_Functor_Compose_compose)($pure, ($dictApplicative1)->pure)), "Apply0" => (function() use ($applyCompose2) {
