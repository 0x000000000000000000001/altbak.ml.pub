...
$__global_Data_Semigroup_First_applyFirst = ($GLOBALS['Data_Semigroup_First_applyFirst'] ?? \Data\Semigroup\First\phpurs_eval_thunk('Data_Semigroup_First_applyFirst'));
  ...
  return $__fn;
      ...
      case 'Data_Semigroup_First_applicativeFirst': $v = (object)["pure" => ($GLOBALS['Data_Semigroup_First_First'] ?? \Data\Semigroup\First\phpurs_eval_thunk('Data_Semigroup_First_First')), "Apply0" => (function() {
  $__fn = function($__dollar____unused) use (&$__fn) {
  $__num = func_num_args();
  if ($__num < 1) {
    return phpurs_curry_fallback($__fn, func_get_args(), 1);
...
$__global_Data_Semigroup_First_applyFirst = ($GLOBALS['Data_Semigroup_First_applyFirst'] ?? \Data\Semigroup\First\phpurs_eval_thunk('Data_Semigroup_First_applyFirst'));
  ...
  return $__fn;
      ...
      case 'Data_Semigroup_First_monadFirst': $v = (object)["Applicative0" => (function() {
  $__fn = function($__dollar____unused) use (&$__fn) {
  $__num = func_num_args();
  if ($__num < 1) {
    return phpurs_curry_fallback($__fn, func_get_args(), 1);
