...
$unfoldable = ($__global_Control_Monad_Gen_unfoldable)($dictMonadRec);
    $__res = (function() use ($__global_Prim_undefined, $unfoldable, $__global_Data_List_Types_unfoldableList, $__global_Data_Map_Internal_fromFoldable, $__global_Data_List_Types_foldableList, $__global_Data_Function_const) {
  $__fn = function($dictMonadGen) use ($__global_Prim_undefined, $unfoldable, $__global_Data_List_Types_unfoldableList, $__global_Data_Map_Internal_fromFoldable, $__global_Data_List_Types_foldableList, $__global_Data_Function_const, &$__fn) {
  $__num = func_num_args();
  if ($__num < 1) {
    return phpurs_curry_fallback($__fn, func_get_args(), 1);
  }
...
$apply = ($Apply0)->apply;
    $__res = (function() use ($__global_Data_Map_Internal_fromFoldable, $__global_Data_List_Types_foldableList, $sized, $bind, $chooseInt, $resize, $__global_Data_Function_const, $map, $unfoldable1, $apply) {
  $__fn = function($dictOrd) use ($__global_Data_Map_Internal_fromFoldable, $__global_Data_List_Types_foldableList, $sized, $bind, $chooseInt, $resize, $__global_Data_Function_const, $map, $unfoldable1, $apply, &$__fn) {
  $__num = func_num_args();
  if ($__num < 1) {
    return phpurs_curry_fallback($__fn, func_get_args(), 1);
  }
