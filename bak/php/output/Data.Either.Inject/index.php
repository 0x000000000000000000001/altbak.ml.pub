...
if (!function_exists(__NAMESPACE__ . '\\phpurs_eval_thunk')) {
  function phpurs_eval_thunk($id) {
    ...
    switch ($id) {
      ...
      case 'Data_Either_Inject_injectReflexive': $v = (object)["inj" => (($GLOBALS['Control_Category_categoryFn'] ?? \Control\Category\phpurs_eval_thunk('Control_Category_categoryFn')))->identity, "prj" => function($value0) {
  $__num = func_num_args();
  ...
  return $__num > 1 ? $__res(...array_slice(func_get_args(), 1)) : $__res;
      ...
      case 'Data_Either_Inject_injectLeft': $v = (object)["inj" => function($value0) {
  $__num = func_num_args();
  $__res = new Phpurs_Data1("Left", $value0);
  goto __end;;
  __end:
  return $__num > 1 ? $__res(...array_slice(func_get_args(), 1)) : $__res;
}, "prj" => \Data\Either\Data_Either_either(function($value0) {
  $__num = func_num_args();
  $__res = new Phpurs_Data1("Just", $value0);
  goto __end;;
  __end:
...
function Data_Either_Inject_injectRight($dictInject) {
  ...
  $__res = (object)["inj" => ($__global_Data_Either_Inject_compose)(function($value0) {
  $__num = func_num_args();
