...
if (!function_exists(__NAMESPACE__ . '\\phpurs_eval_thunk')) {
  function phpurs_eval_thunk($id) {
    ...
    switch ($id) {
      case 'Control_Comonad_Store_map': $v = (($GLOBALS['Data_Tuple_functorTuple'] ?? \Data\Tuple\phpurs_eval_thunk('Data_Tuple_functorTuple')))->map; break;
...
function Control_Comonad_Store_runStore($v) {
  ...
  $__body = function($v) {
    $__global_Data_Tuple_swap = ($GLOBALS['Data_Tuple_swap'] ?? \Data\Tuple\phpurs_eval_thunk('Data_Tuple_swap'));
    $__global_Control_Comonad_Store_map = ($GLOBALS['Control_Comonad_Store_map'] ?? \Control\Comonad\Store\phpurs_eval_thunk('Control_Comonad_Store_map'));
    $__global_Control_Comonad_Store_unwrap = ($GLOBALS['Control_Comonad_Store_unwrap'] ?? \Control\Comonad\Store\phpurs_eval_thunk('Control_Comonad_Store_unwrap'));
    $__case_0 = $v;
    if (true) {
$s = $__case_0;
return ($__global_Data_Tuple_swap)(($__global_Control_Comonad_Store_map)($__global_Control_Comonad_Store_unwrap, ($__global_Data_Tuple_swap)($s)));
} else {
