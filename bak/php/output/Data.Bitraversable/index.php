...
if (!function_exists(__NAMESPACE__ . '\\phpurs_eval_thunk')) {
  function phpurs_eval_thunk($id) {
    ...
    switch ($id) {
      ...
      case 'Data_Bitraversable_bitraversableTuple': $v = (object)["bitraverse" => (function() {
...
$__global_Data_Bifoldable_bifoldableTuple = ($GLOBALS['Data_Bifoldable_bifoldableTuple'] ?? \Data\Bifoldable\phpurs_eval_thunk('Data_Bifoldable_bifoldableTuple'));
  ...
  return $__fn;
      ...
      case 'Data_Bitraversable_bitraversableEither': $v = (object)["bitraverse" => (function() {
  $__fn = function($dictApplicative) use (&$__fn) {
  $__num = func_num_args();
  if ($__num < 1) {
    return phpurs_curry_fallback($__fn, func_get_args(), 1);
...
$__global_Data_Bifoldable_bifoldableEither = ($GLOBALS['Data_Bifoldable_bifoldableEither'] ?? \Data\Bifoldable\phpurs_eval_thunk('Data_Bifoldable_bifoldableEither'));
  ...
  return $__fn;
      ...
      case 'Data_Bitraversable_bitraversableConst': $v = (object)["bitraverse" => (function() {
  $__fn = function($dictApplicative) use (&$__fn) {
  $__num = func_num_args();
  if ($__num < 1) {
    return phpurs_curry_fallback($__fn, func_get_args(), 1);
...
$bifoldableJoker = ($__global_Data_Bifoldable_bifoldableJoker)((($dictTraversable)->Foldable1)($__global_Prim_undefined));
    $__res = (object)["bitraverse" => (function() use ($__global_Prim_undefined, $traverse, $__global_Data_Functor_Joker_Joker) {
  $__fn = function($dictApplicative) use ($__global_Prim_undefined, $traverse, $__global_Data_Functor_Joker_Joker, &$__fn) {
  $__num = func_num_args();
  if ($__num < 1) {
    return phpurs_curry_fallback($__fn, func_get_args(), 1);
  }
...
throw new \Exception("Pattern match failure");
  ...
  return $__fn;
})(), "bisequence" => (function() use ($__global_Prim_undefined, $sequence, $__global_Data_Functor_Joker_Joker) {
  $__fn = function($dictApplicative) use ($__global_Prim_undefined, $sequence, $__global_Data_Functor_Joker_Joker, &$__fn) {
  $__num = func_num_args();
  if ($__num < 1) {
    return phpurs_curry_fallback($__fn, func_get_args(), 1);
  }
...
$bifoldableClown = ($__global_Data_Bifoldable_bifoldableClown)((($dictTraversable)->Foldable1)($__global_Prim_undefined));
    $__res = (object)["bitraverse" => (function() use ($__global_Prim_undefined, $traverse, $__global_Data_Functor_Clown_Clown) {
  $__fn = function($dictApplicative) use ($__global_Prim_undefined, $traverse, $__global_Data_Functor_Clown_Clown, &$__fn) {
  $__num = func_num_args();
  if ($__num < 1) {
    return phpurs_curry_fallback($__fn, func_get_args(), 1);
  }
...
throw new \Exception("Pattern match failure");
  ...
  return $__fn;
})(), "bisequence" => (function() use ($__global_Prim_undefined, $sequence, $__global_Data_Functor_Clown_Clown) {
  $__fn = function($dictApplicative) use ($__global_Prim_undefined, $sequence, $__global_Data_Functor_Clown_Clown, &$__fn) {
  $__num = func_num_args();
  if ($__num < 1) {
    return phpurs_curry_fallback($__fn, func_get_args(), 1);
  }
...
$bifoldableFlip = ($__global_Data_Bifoldable_bifoldableFlip)((($dictBitraversable)->Bifoldable1)($__global_Prim_undefined));
    $__res = (object)["bitraverse" => (function() use ($__global_Prim_undefined, $bitraverse1, $__global_Data_Functor_Flip_Flip) {
  $__fn = function($dictApplicative) use ($__global_Prim_undefined, $bitraverse1, $__global_Data_Functor_Flip_Flip, &$__fn) {
  $__num = func_num_args();
  if ($__num < 1) {
    return phpurs_curry_fallback($__fn, func_get_args(), 1);
  }
...
throw new \Exception("Pattern match failure");
  ...
  return $__fn;
})(), "bisequence" => (function() use ($__global_Prim_undefined, $bisequence1, $__global_Data_Functor_Flip_Flip) {
  $__fn = function($dictApplicative) use ($__global_Prim_undefined, $bisequence1, $__global_Data_Functor_Flip_Flip, &$__fn) {
  $__num = func_num_args();
  if ($__num < 1) {
    return phpurs_curry_fallback($__fn, func_get_args(), 1);
  }
...
$bifoldableProduct2 = ($__global_Data_Bifoldable_bifoldableProduct2)((($dictBitraversable)->Bifoldable1)($__global_Prim_undefined));
    $__res = (function() use ($bifunctorProduct2, $__global_Prim_undefined, $bifoldableProduct2, $bitraverse1, $bisequence1) {
  $__fn = function($dictBitraversable1) use ($bifunctorProduct2, $__global_Prim_undefined, $bifoldableProduct2, $bitraverse1, $bisequence1, &$__fn) {
  $__num = func_num_args();
  if ($__num < 1) {
    return phpurs_curry_fallback($__fn, func_get_args(), 1);
  }
...
$bifoldableProduct21 = ($bifoldableProduct2)((($dictBitraversable1)->Bifoldable1)($__global_Prim_undefined));
    $__res = (object)["bitraverse" => (function() use ($__global_Prim_undefined, $bitraverse1, $bitraverse2) {
  $__fn = function($dictApplicative) use ($__global_Prim_undefined, $bitraverse1, $bitraverse2, &$__fn) {
  $__num = func_num_args();
  if ($__num < 1) {
    return phpurs_curry_fallback($__fn, func_get_args(), 1);
  }
...
break;
  ...
  return $__fn;
})(), "bisequence" => (function() use ($__global_Prim_undefined, $bisequence1, $bisequence2) {
  $__fn = function($dictApplicative) use ($__global_Prim_undefined, $bisequence1, $bisequence2, &$__fn) {
  $__num = func_num_args();
  if ($__num < 1) {
    return phpurs_curry_fallback($__fn, func_get_args(), 1);
  }
