...
$tailRecM = ($dictMonadRec)->tailRecM;
    $__res = (function() use ($__global_Prim_undefined, $__global_Control_Monad_Gen_compose, $tailRecM) {
  $__fn = function($dictMonadGen) use ($__global_Prim_undefined, $__global_Control_Monad_Gen_compose, $tailRecM, &$__fn) {
  $__num = func_num_args();
  if ($__num < 1) {
    return phpurs_curry_fallback($__fn, func_get_args(), 1);
  }
...
$foldr = ((($dictFoldable1)->Foldable0)($__global_Prim_undefined))->foldr;
    $__res = (function() use ($__global_Control_Monad_Gen_un, $__global_Data_Semigroup_Last_Last, $foldMap1, $foldr) {
...
$go = (function() use (&$go, $__global_Control_Monad_Gen_un, $__global_Data_Semigroup_Last_Last, $foldMap1, $xs) {
...
$chooseInt = ($dictMonadGen)->chooseInt;
    $__res = (function() use ($__global_Data_Foldable_length, $__global_Prim_undefined, $__global_Data_Semiring_semiringInt, $__global_Control_Monad_Gen_fromIndex, $bind, $chooseInt) {
  $__fn = function($dictFoldable1) use ($__global_Data_Foldable_length, $__global_Prim_undefined, $__global_Data_Semiring_semiringInt, $__global_Control_Monad_Gen_fromIndex, $bind, $chooseInt, &$__fn) {
  $__num = func_num_args();
  if ($__num < 1) {
    return phpurs_curry_fallback($__fn, func_get_args(), 1);
  }
...
$fromIndex1 = ($__global_Control_Monad_Gen_fromIndex)($dictFoldable1);
  ...
  if ($__num < 1) {
    ...
    $__res = ($bind)(($chooseInt)(0, (($length)($xs) - 1)), (function() use ($fromIndex1, $xs) {
...
$weight = ($__case_0)->v0;
$x = ($__case_0)->v1;
return (function() use ($__global_Control_Monad_Gen_greaterThanOrEq, $weight, $x) {
  $__body = function($pos) use ($__global_Control_Monad_Gen_greaterThanOrEq, $weight, $x) {
...
break;
  ...
  $__fn = function($pos) use ($__global_Control_Monad_Gen_greaterThanOrEq, $weight, $x, $__body, &$__fn) {
  $__num = func_num_args();
  if ($__num < 1) {
    return phpurs_curry_fallback($__fn, func_get_args(), 1);
  }
...
$tailRecM = ($dictMonadRec)->tailRecM;
    $__res = (function() use ($__global_Data_Functor_mapFlipped, $__global_Prim_undefined, $__global_Data_Unit_unit, $tailRecM) {
  $__fn = function($dictMonadGen) use ($__global_Data_Functor_mapFlipped, $__global_Prim_undefined, $__global_Data_Unit_unit, $tailRecM, &$__fn) {
  $__num = func_num_args();
  if ($__num < 1) {
    return phpurs_curry_fallback($__fn, func_get_args(), 1);
  }
...
$filtered1 = ($__global_Control_Monad_Gen_filtered)($dictMonadRec);
    $__res = (function() use ($filtered1, $__global_Data_Functor_mapFlipped, $__global_Prim_undefined) {
  $__fn = function($dictMonadGen) use ($filtered1, $__global_Data_Functor_mapFlipped, $__global_Prim_undefined, &$__fn) {
  $__num = func_num_args();
  if ($__num < 1) {
    return phpurs_curry_fallback($__fn, func_get_args(), 1);
  }
...
$chooseInt = ($dictMonadGen)->chooseInt;
$pure = ((($Monad0)->Applicative0)($__global_Prim_undefined))->pure;
    $__res = (function() use ($__global_Data_Foldable_length, $__global_Prim_undefined, $__global_Data_Semiring_semiringInt, $__global_Control_Monad_Gen_fromIndex, $bind, $chooseInt, $pure) {
  $__fn = function($dictFoldable1) use ($__global_Data_Foldable_length, $__global_Prim_undefined, $__global_Data_Semiring_semiringInt, $__global_Control_Monad_Gen_fromIndex, $bind, $chooseInt, $pure, &$__fn) {
  $__num = func_num_args();
  if ($__num < 1) {
    return phpurs_curry_fallback($__fn, func_get_args(), 1);
  }
...
$fromIndex1 = ($__global_Control_Monad_Gen_fromIndex)($dictFoldable1);
  ...
  if ($__num < 1) {
    ...
    $__res = ($bind)(($chooseInt)(0, (($length)($xs) - 1)), (function() use ($pure, $fromIndex1, $xs) {
