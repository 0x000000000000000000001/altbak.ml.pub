...
$pure = ((((($dictMonadGen)->Monad0)($__global_Prim_undefined))->Applicative0)($__global_Prim_undefined))->pure;
    $__res = (function() use ($__global_Prim_undefined, $__global_Data_Enum_enumFromTo, $__global_Data_Unfoldable1_unfoldable1Array, $elements, $pure) {
  $__body = function($dictBoundedEnum) use ($__global_Prim_undefined, $__global_Data_Enum_enumFromTo, $__global_Data_Unfoldable1_unfoldable1Array, $elements, $pure) {
...
break;
  ...
  $__fn = function($dictBoundedEnum) use ($__global_Prim_undefined, $__global_Data_Enum_enumFromTo, $__global_Data_Unfoldable1_unfoldable1Array, $elements, $pure, $__body, &$__fn) {
  $__num = func_num_args();
  if ($__num < 1) {
    return phpurs_curry_fallback($__fn, func_get_args(), 1);
  }
