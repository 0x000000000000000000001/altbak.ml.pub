...
$state1 = ($dictMonadState)->state;
  ...
  if ($__num < 1) {
    ...
    $__res = ($state1)((function() use ($__global_Data_Unit_unit, $s) {
...
$state1 = ($dictMonadState)->state;
  ...
  if ($__num < 1) {
    ...
    $__res = ($state1)((function() use ($__global_Data_Unit_unit, $f) {
  $__fn = function($s) use ($__global_Data_Unit_unit, $f, &$__fn) {
  $__num = func_num_args();
  if ($__num < 1) {
    return phpurs_curry_fallback($__fn, func_get_args(), 1);
  }
