...
$__global_Data_List_Lazy_NonEmpty_toList = ($GLOBALS['Data_List_Lazy_NonEmpty_toList'] ?? \Data\List\Lazy\NonEmpty\phpurs_eval_thunk('Data_List_Lazy_NonEmpty_toList'));
  ...
  if ($__num < 1) {
    ...
    $__res = ($__global_Data_List_Lazy_NonEmpty_map)((function() {
...
$__global_Data_List_Lazy_repeat = ($GLOBALS['Data_List_Lazy_repeat'] ?? \Data\List\Lazy\phpurs_eval_thunk('Data_List_Lazy_repeat'));
    $__res = ($__global_Data_Lazy_defer)((function() use ($x, $__global_Data_List_Lazy_repeat) {
  $__fn = function($v) use ($x, $__global_Data_List_Lazy_repeat, &$__fn) {
  $__num = func_num_args();
  if ($__num < 1) {
    return phpurs_curry_fallback($__fn, func_get_args(), 1);
  }
  ...
  return $__fn;
})())($x, ($__global_Data_List_Lazy_repeat)($x));
  return $__num > 1 ? $__res(...array_slice(func_get_args(), 1)) : $__res;
  };
  return $__fn;
})());
...
$x = ($__case_0)->v0;
$xs = ($__case_0)->v1;
return ($__global_Data_Maybe_fromMaybe)($x, ($__global_Data_List_Lazy_last)($xs));
break;
default:
throw new \Exception("Pattern match failure");
break;
...
$__global_Data_List_Lazy_iterate = ($GLOBALS['Data_List_Lazy_iterate'] ?? \Data\List\Lazy\phpurs_eval_thunk('Data_List_Lazy_iterate'));
    $__res = ($__global_Data_Lazy_defer)((function() use ($x, $__global_Data_List_Lazy_iterate, $f) {
  $__fn = function($v) use ($x, $__global_Data_List_Lazy_iterate, $f, &$__fn) {
  $__num = func_num_args();
  if ($__num < 1) {
    return phpurs_curry_fallback($__fn, func_get_args(), 1);
  }
  ...
  return $__fn;
})())($x, ($__global_Data_List_Lazy_iterate)($f, ($f)($x)));
  return $__num > 1 ? $__res(...array_slice(func_get_args(), 1)) : $__res;
  };
  return $__fn;
})());
...
$x = ($__case_0)->v0;
$xs = ($__case_0)->v1;
return ($__global_Data_Maybe_maybe)($__global_Data_List_Lazy_Types_nil, (function() use ($__global_Data_List_Lazy_Types_cons, $x) {
  $__fn = function($v2) use ($__global_Data_List_Lazy_Types_cons, $x, &$__fn) {
  $__num = func_num_args();
  if ($__num < 1) {
    return phpurs_curry_fallback($__fn, func_get_args(), 1);
  }
...
return ((function() {
  ...
  return $__fn;
})())(($__global_Data_Lazy_defer)((function() use ($x, $xs) {
...
$y1 = $__case_0;
$nel = $__case_1;
return ($__global_Data_Lazy_defer)((function() use ($__global_Data_Lazy_force, $nel, $y1, $__global_Data_List_Lazy_Types_cons) {
  $__body = function($v1) use ($__global_Data_Lazy_force, $nel, $y1, $__global_Data_List_Lazy_Types_cons) {
...
return ((function() {
  ...
  return $__fn;
})())($y1, ($__global_Data_List_Lazy_Types_cons)($x, $xs));
break;
default:
throw new \Exception("Pattern match failure");
break;
  ...
  $__fn = function($v1) use ($__global_Data_Lazy_force, $nel, $y1, $__global_Data_List_Lazy_Types_cons, $__body, &$__fn) {
  $__num = func_num_args();
  if ($__num < 1) {
    return phpurs_curry_fallback($__fn, func_get_args(), 1);
  }
...
$fromFoldable1 = ($__global_Data_List_Lazy_fromFoldable)($dictFoldable);
  ...
  if ($__num < 2) {
    ...
    $__res = ($__global_Data_Lazy_defer)((function() use ($__global_Data_List_Lazy_NonEmpty_head, $nel, $__global_Data_List_Lazy_NonEmpty_append, $__global_Data_List_Lazy_NonEmpty_tail, $fromFoldable1, $ys) {
  $__fn = function($v) use ($__global_Data_List_Lazy_NonEmpty_head, $nel, $__global_Data_List_Lazy_NonEmpty_append, $__global_Data_List_Lazy_NonEmpty_tail, $fromFoldable1, $ys, &$__fn) {
  $__num = func_num_args();
  if ($__num < 1) {
    return phpurs_curry_fallback($__fn, func_get_args(), 1);
  }
  ...
  return $__fn;
})())(($__global_Data_List_Lazy_NonEmpty_head)($nel), ($__global_Data_List_Lazy_NonEmpty_append)(($__global_Data_List_Lazy_NonEmpty_tail)($nel), ($fromFoldable1)($ys)));
  return $__num > 1 ? $__res(...array_slice(func_get_args(), 1)) : $__res;
  };
  return $__fn;
})());
