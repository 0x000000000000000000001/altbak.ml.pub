...
$up = (function() use ($__global_Data_List_Internal_fromZipper, &$up) {
...
$k__prime__ = ($__case_1)->v1;
$mid = ($__case_1)->v2;
return ($__global_Data_List_Internal_fromZipper)($ctx, ((function() {
  $__fn = function($value0, $value1 = null, $value2 = null, $value3 = null, $value4 = null) use (&$__fn) {
  $__num = func_num_args();
  if ($__num < 5) {
    return phpurs_curry_fallback($__fn, func_get_args(), 5);
...
case "Leaf":
$ctx = $__case_0;
return (object)["found" => false, "result" => ($up)($ctx, ((function() {
  $__fn = function($value0, $value1 = null, $value2 = null) use (&$__fn) {
  $__num = func_num_args();
  if ($__num < 3) {
    if ($__num === 2) return function($value2) use ($value0, $value1, &$__fn) { return $__fn($value0, $value1, $value2); };
  ...
  return $__fn;
})())(($GLOBALS['__phpurs_data0_Leaf'] ??= new Phpurs_Data0("Leaf")), $k, ($GLOBALS['__phpurs_data0_Leaf'] ??= new Phpurs_Data0("Leaf"))))];
break;
case "Two":
$ctx = $__case_0;
$left = ($__case_1)->v0;
