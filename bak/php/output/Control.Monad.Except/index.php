...
if (!function_exists(__NAMESPACE__ . '\\phpurs_eval_thunk')) {
  function phpurs_eval_thunk($id) {
    ...
    switch ($id) {
      case 'Control_Monad_Except_compose': $v = (($GLOBALS['Control_Semigroupoid_semigroupoidFn'] ?? \Control\Semigroupoid\phpurs_eval_thunk('Control_Semigroupoid_semigroupoidFn')))->compose; break;
...
$__global_Control_Monad_Except_compose = ($GLOBALS['Control_Monad_Except_compose'] ?? \Control\Monad\Except\phpurs_eval_thunk('Control_Monad_Except_compose'));
$__global_Data_Identity_Identity = ($GLOBALS['Data_Identity_Identity'] ?? \Data\Identity\phpurs_eval_thunk('Data_Identity_Identity'));
$__global_Control_Monad_Except_unwrap = ($GLOBALS['Control_Monad_Except_unwrap'] ?? \Control\Monad\Except\phpurs_eval_thunk('Control_Monad_Except_unwrap'));
    $__res = ($__global_Control_Monad_Except_Trans_mapExceptT)(($__global_Control_Monad_Except_compose)($__global_Data_Identity_Identity, ($__global_Control_Monad_Except_compose)($f, $__global_Control_Monad_Except_unwrap)));
