...
$__global_Control_Apply_lift2 = ($GLOBALS['Control_Apply_lift2'] ?? \Control\Apply\phpurs_eval_thunk('Control_Apply_lift2'));
    $__res = ($__global_Control_Apply_lift2)($dictApply, (function() {
...
$unfoldable = ($__global_Control_Monad_Gen_unfoldable)($dictMonadRec);
    $__res = (function() use ($__global_Prim_undefined, $unfoldable, $__global_Control_Monad_Gen_Common_compose, $__global_Control_Monad_Gen_Common_max) {
  $__fn = function($dictMonadGen) use ($__global_Prim_undefined, $unfoldable, $__global_Control_Monad_Gen_Common_compose, $__global_Control_Monad_Gen_Common_max, &$__fn) {
  $__num = func_num_args();
  if ($__num < 1) {
    return phpurs_curry_fallback($__fn, func_get_args(), 1);
  }
...
$unfoldable1 = ($unfoldable)($dictMonadGen);
    $__res = (function() use ($unfoldable1, $apply, $map, $resize, $__global_Control_Monad_Gen_Common_compose, $__global_Control_Monad_Gen_Common_max) {
  $__fn = function($dictUnfoldable) use ($unfoldable1, $apply, $map, $resize, $__global_Control_Monad_Gen_Common_compose, $__global_Control_Monad_Gen_Common_max, &$__fn) {
  $__num = func_num_args();
  if ($__num < 1) {
    return phpurs_curry_fallback($__fn, func_get_args(), 1);
  }
$unfoldable2 = ($unfoldable1)($dictUnfoldable);
    $__res = (function() use ($apply, $map, $resize, $__global_Control_Monad_Gen_Common_compose, $__global_Control_Monad_Gen_Common_max, $unfoldable2) {
  $__fn = function($gen) use ($apply, $map, $resize, $__global_Control_Monad_Gen_Common_compose, $__global_Control_Monad_Gen_Common_max, $unfoldable2, &$__fn) {
  $__num = func_num_args();
  if ($__num < 1) {
    return phpurs_curry_fallback($__fn, func_get_args(), 1);
  }
  ...
  return $__fn;
})(), $gen), ($resize)(($__global_Control_Monad_Gen_Common_compose)(($__global_Control_Monad_Gen_Common_max)(0), (function() {
