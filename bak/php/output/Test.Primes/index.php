...
return ((function() {
  ...
  return $__fn;
})())($p, (($GLOBALS['Test_Primes_sieve'] ?? \Test\Primes\phpurs_eval_thunk('Test_Primes_sieve')))(($__global_Test_Primes_filter)((function() use ($__global_Test_Primes_notEq, $__global_Data_EuclideanRing_intMod, $p) {
