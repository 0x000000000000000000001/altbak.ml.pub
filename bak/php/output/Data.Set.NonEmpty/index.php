...
if (!function_exists(__NAMESPACE__ . '\\phpurs_eval_thunk')) {
  function phpurs_eval_thunk($id) {
    ...
    switch ($id) {
      ...
      case 'Data_Set_NonEmpty_toUnfoldable11': $v = (($GLOBALS['Data_Set_NonEmpty_toUnfoldable1'] ?? \Data\Set\NonEmpty\phpurs_eval_thunk('Data_Set_NonEmpty_toUnfoldable1')))(($GLOBALS['Data_Unfoldable1_unfoldable1Array'] ?? \Data\Unfoldable1\phpurs_eval_thunk('Data_Unfoldable1_unfoldable1Array'))); break;
...
$stepHead = ($__global_Data_Map_Internal_stepAscCps)(($__global_Data_Function_Uncurried_mkFn3)((function() {
  ...
  return $__fn;
    ...
    $__res = ($__global_Data_Set_NonEmpty_compose)((($dictUnfoldable1)->unfoldr1)((function() use ($__global_Data_Set_NonEmpty_map1, $stepNext) {
...
$show = (($__global_Data_Array_NonEmpty_Internal_showNonEmptyArray)($dictShow))->show;
    $__res = (object)["show" => (function() use ($show, $__global_Data_Set_NonEmpty_toUnfoldable11) {
  $__fn = function($s) use ($show, $__global_Data_Set_NonEmpty_toUnfoldable11, &$__fn) {
  $__num = func_num_args();
  if ($__num < 1) {
    return phpurs_curry_fallback($__fn, func_get_args(), 1);
  }
...
$foldMap11 = ($dictFoldable1)->foldMap1;
    $__res = (function() use ($foldMap11, $__global_Data_Set_NonEmpty_semigroupNonEmptySet, $__global_Data_Set_NonEmpty_singleton) {
  $__fn = function($dictOrd) use ($foldMap11, $__global_Data_Set_NonEmpty_semigroupNonEmptySet, $__global_Data_Set_NonEmpty_singleton, &$__fn) {
  $__num = func_num_args();
  if ($__num < 1) {
    return phpurs_curry_fallback($__fn, func_get_args(), 1);
  }
