...
if (!function_exists(__NAMESPACE__ . '\\phpurs_eval_thunk')) {
  function phpurs_eval_thunk($id) {
    ...
    switch ($id) {
      case 'Data_Semigroup_Generic_genericSemigroupNoConstructors': $v = (object)["genericAppend'" => (function() {
  ...
  return $__fn;
      ...
      case 'Data_Semigroup_Generic_genericSemigroupNoArguments': $v = (object)["genericAppend'" => (function() {
  $__fn = function($a, $v = null) use (&$__fn) {
  $__num = func_num_args();
  if ($__num < 2) {
    if ($__num === 1) return function($v) use ($a, &$__fn) { return $__fn($a, $v); };
...
$a1 = $__case_0;
$a2 = $__case_1;
return ($genericAppend__prime__1)($a1, $a2);
} else {
throw new \Exception("Pattern match failure");
};
  };
...
return ((function() {
  ...
  return $__fn;
})())(($genericAppend__prime__1)($a1, $a2), ($genericAppend__prime__2)($b1, $b2));
} else {
throw new \Exception("Pattern match failure");
};
  };
