...
$p = $__case_0;
$q = $__case_1;
return ($__global_Data_Comparison_append)($p, $q);
} else {
throw new \Exception("Pattern match failure");
  ...
  return $__fn;
      ...
      case 'Data_Comparison_newtypeComparison': $v = (object)["Coercible0" => (function() {
...
$__global_Prim_undefined = ($GLOBALS['Prim_undefined'] ?? \Prim\phpurs_eval_thunk('Prim_undefined'));
  ...
  return $__fn;
      ...
      case 'Data_Comparison_monoidComparison': $v = (object)["mempty" => (function() {
...
$__global_Data_Comparison_semigroupComparison = ($GLOBALS['Data_Comparison_semigroupComparison'] ?? \Data\Comparison\phpurs_eval_thunk('Data_Comparison_semigroupComparison'));
    $__res = $__global_Data_Comparison_semigroupComparison;
  return $__num > 1 ? $__res(...array_slice(func_get_args(), 1)) : $__res;
  };
  return $__fn;
})()]; break;
      case 'Data_Comparison_contravariantComparison': $v = (object)["cmap" => (function() {
  $__body = function($f, $v) {
...
$f1 = $__case_0;
$g = $__case_1;
return ($__global_Data_Function_on)($g, $f1);
} else {
throw new \Exception("Pattern match failure");
};
  };
...
function Data_Comparison_Comparison($x) {
  $__num = func_num_args();
  $__fn = __NAMESPACE__ . '\\' . 'Data_Comparison_Comparison';
  if ($__num < 1) {
    return phpurs_curry_fallback($__fn, func_get_args(), 1);
  }
    $__res = $x;
...
$GLOBALS['Data_Comparison_Comparison'] = __NAMESPACE__ . '\\Data_Comparison_Comparison';




// Data_Comparison_defaultComparison
function Data_Comparison_defaultComparison($dictOrd) {
  $__num = func_num_args();
  $__fn = __NAMESPACE__ . '\\' . 'Data_Comparison_defaultComparison';
  if ($__num < 1) {
    return phpurs_curry_fallback($__fn, func_get_args(), 1);
  }
