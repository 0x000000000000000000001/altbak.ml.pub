...
if (!function_exists(__NAMESPACE__ . '\\phpurs_eval_thunk')) {
  function phpurs_eval_thunk($id) {
    ...
    switch ($id) {
      case 'Data_Divisible_divisiblePredicate': $v = (object)["conquer" => \Data\Function\Data_Function_const(true), "Divide0" => function($__dollar____unused) {
  $__num = func_num_args();
  ...
  return $__num > 1 ? $__res(...array_slice(func_get_args(), 1)) : $__res;
      ...
      case 'Data_Divisible_divisibleEquivalence': $v = (object)["conquer" => (function() use (&$__fn) {
  ...
  return $__num > 1 ? $__res(...array_slice(func_get_args(), 1)) : $__res;
      ...
      case 'Data_Divisible_divisibleComparison': $v = (object)["conquer" => (function() use (&$__fn) {
  $__fn = function($v, $v1 = null) use (&$__fn) {
  $__num = func_num_args();
  if ($__num < 2) {
    if ($__num === 1) return function($v1) use ($v, &$__fn) { return $__fn($v, $v1); };
...
function Data_Divisible_divisibleOp($dictMonoid) {
  ...
  $__res = (object)["conquer" => ($__global_Data_Function_const)(($dictMonoid)->mempty), "Divide0" => function($__dollar____unused) use ($divideOp) {
  $__num = func_num_args();
  $__res = $divideOp;
  goto __end;;
  __end:
