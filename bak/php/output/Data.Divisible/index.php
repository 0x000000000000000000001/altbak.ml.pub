...
if (!function_exists(__NAMESPACE__ . '\\phpurs_eval_thunk')) {
  function phpurs_eval_thunk($id) {
    ...
    switch ($id) {
      case 'Data_Divisible_divisiblePredicate': $v = (object)["conquer" => (($GLOBALS['Data_Function_const'] ?? \Data\Function\phpurs_eval_thunk('Data_Function_const')))(true), "Divide0" => (function() {
...
$__global_Data_Divide_dividePredicate = ($GLOBALS['Data_Divide_dividePredicate'] ?? \Data\Divide\phpurs_eval_thunk('Data_Divide_dividePredicate'));
  ...
  return $__fn;
      ...
      case 'Data_Divisible_divisibleEquivalence': $v = (object)["conquer" => (function() {
...
$__global_Data_Divide_divideEquivalence = ($GLOBALS['Data_Divide_divideEquivalence'] ?? \Data\Divide\phpurs_eval_thunk('Data_Divide_divideEquivalence'));
  ...
  return $__fn;
      ...
      case 'Data_Divisible_divisibleComparison': $v = (object)["conquer" => (function() {
  $__fn = function($v, $v1 = null) use (&$__fn) {
  $__num = func_num_args();
  if ($__num < 2) {
    if ($__num === 1) return function($v1) use ($v, &$__fn) { return $__fn($v, $v1); };
...
function Data_Divisible_Divisible__dollar__Dict($x) {
  $__num = func_num_args();
  $__fn = __NAMESPACE__ . '\\' . 'Data_Divisible_Divisible__dollar__Dict';
  if ($__num < 1) {
    return phpurs_curry_fallback($__fn, func_get_args(), 1);
  }
    $__res = $x;
...
$GLOBALS['Data_Divisible_Divisible__dollar__Dict'] = __NAMESPACE__ . '\\Data_Divisible_Divisible__dollar__Dict';


// Data_Divisible_divisibleOp
function Data_Divisible_divisibleOp($dictMonoid) {
  $__num = func_num_args();
  $__fn = __NAMESPACE__ . '\\' . 'Data_Divisible_divisibleOp';
  if ($__num < 1) {
    return phpurs_curry_fallback($__fn, func_get_args(), 1);
  }
...
$GLOBALS['Data_Divisible_divisibleOp'] = __NAMESPACE__ . '\\Data_Divisible_divisibleOp';



// Data_Divisible_conquer
function Data_Divisible_conquer($dict) {
  $__num = func_num_args();
  $__fn = __NAMESPACE__ . '\\' . 'Data_Divisible_conquer';
  if ($__num < 1) {
    return phpurs_curry_fallback($__fn, func_get_args(), 1);
  }
...
$GLOBALS['Data_Divisible_conquer'] = __NAMESPACE__ . '\\Data_Divisible_conquer';
