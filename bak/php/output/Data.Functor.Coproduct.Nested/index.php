...
if (!function_exists(__NAMESPACE__ . '\\phpurs_eval_thunk')) {
  function phpurs_eval_thunk($id) {
    ...
    switch ($id) {
      case 'Data_Functor_Coproduct_Nested_unwrap': $v = (($GLOBALS['Data_Newtype_unwrap'] ?? \Data\Newtype\phpurs_eval_thunk('Data_Newtype_unwrap')))(($GLOBALS['Prim_undefined'] ?? \Prim\phpurs_eval_thunk('Prim_undefined'))); break;
      case 'Data_Functor_Coproduct_Nested_in1': $v = ($GLOBALS['Data_Functor_Coproduct_left'] ?? \Data\Functor\Coproduct\phpurs_eval_thunk('Data_Functor_Coproduct_left')); break;
...
case "Right":
$_9 = ($__case_0)->v0;
return ($__global_Data_Void_absurd)(($__global_Data_Functor_Coproduct_Nested_unwrap)($_9));
break;
default:
...
case "Right":
$_8 = ($__case_0)->v0;
return ($__global_Data_Void_absurd)(($__global_Data_Functor_Coproduct_Nested_unwrap)($_8));
break;
default:
throw new \Exception("Pattern match failure");
break;
...
case "Right":
$_7 = ($__case_0)->v0;
return ($__global_Data_Void_absurd)(($__global_Data_Functor_Coproduct_Nested_unwrap)($_7));
break;
default:
throw new \Exception("Pattern match failure");
break;
...
case "Right":
$_6 = ($__case_0)->v0;
return ($__global_Data_Void_absurd)(($__global_Data_Functor_Coproduct_Nested_unwrap)($_6));
break;
default:
throw new \Exception("Pattern match failure");
break;
...
case "Right":
$_5 = ($__case_0)->v0;
return ($__global_Data_Void_absurd)(($__global_Data_Functor_Coproduct_Nested_unwrap)($_5));
break;
default:
throw new \Exception("Pattern match failure");
break;
...
case "Right":
$_4 = ($__case_0)->v0;
return ($__global_Data_Void_absurd)(($__global_Data_Functor_Coproduct_Nested_unwrap)($_4));
break;
default:
throw new \Exception("Pattern match failure");
break;
...
case "Right":
$_3 = ($__case_0)->v0;
return ($__global_Data_Void_absurd)(($__global_Data_Functor_Coproduct_Nested_unwrap)($_3));
break;
default:
throw new \Exception("Pattern match failure");
break;
...
case "Right":
$_2 = ($__case_0)->v0;
return ($__global_Data_Void_absurd)(($__global_Data_Functor_Coproduct_Nested_unwrap)($_2));
break;
default:
throw new \Exception("Pattern match failure");
break;
...
case "Right":
$_10 = ($__case_0)->v0;
return ($__global_Data_Void_absurd)(($__global_Data_Functor_Coproduct_Nested_unwrap)($_10));
break;
default:
throw new \Exception("Pattern match failure");
break;
...
case "Right":
$_1 = ($__case_0)->v0;
return ($__global_Data_Void_absurd)(($__global_Data_Functor_Coproduct_Nested_unwrap)($_1));
break;
default:
throw new \Exception("Pattern match failure");
break;
