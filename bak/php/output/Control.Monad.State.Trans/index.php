...
$__global_Prim_undefined = ($GLOBALS['Prim_undefined'] ?? \Prim\phpurs_eval_thunk('Prim_undefined'));
  ...
  return $__fn;
      ...
      case 'Control_Monad_State_Trans_monadTransStateT': $v = (object)["lift" => (function() {
...
while (true) {
return (object)["Applicative0" => (function() use ($__global_Control_Monad_State_Trans_applicativeStateT, $dictMonad) {
  $__fn = function($__dollar____unused) use ($__global_Control_Monad_State_Trans_applicativeStateT, $dictMonad, &$__fn) {
  $__num = func_num_args();
  if ($__num < 1) {
    return phpurs_curry_fallback($__fn, func_get_args(), 1);
  }
  ...
  return $__fn;
})(), "Bind1" => (function() use ($__global_Control_Monad_State_Trans_bindStateT, $dictMonad) {
  $__fn = function($__dollar____unused) use ($__global_Control_Monad_State_Trans_bindStateT, $dictMonad, &$__fn) {
  $__num = func_num_args();
  if ($__num < 1) {
    return phpurs_curry_fallback($__fn, func_get_args(), 1);
  }
...
throw new \Exception("Pattern match failure");
  ...
  return $__fn;
})(), "Apply0" => (function() use ($__global_Control_Monad_State_Trans_applyStateT, $dictMonad) {
  $__fn = function($__dollar____unused) use ($__global_Control_Monad_State_Trans_applyStateT, $dictMonad, &$__fn) {
  $__num = func_num_args();
  if ($__num < 1) {
    return phpurs_curry_fallback($__fn, func_get_args(), 1);
  }
...
return (object)["apply" => ($__global_Control_Monad_ap)(($__global_Control_Monad_State_Trans_monadStateT)($dictMonad)), "Functor0" => (function() use ($functorStateT1) {
...
$monadStateT1 = ($__global_Control_Monad_State_Trans_monadStateT)($Monad0);
    $__res = (object)["ask" => ($__global_Control_Monad_State_Trans_lift)($Monad0, ($dictMonadAsk)->ask), "Monad0" => (function() use ($monadStateT1) {
...
$monadAskStateT1 = ($__global_Control_Monad_State_Trans_monadAskStateT)((($dictMonadReader)->MonadAsk0)($__global_Prim_undefined));
    $__res = (object)["local" => ($__global_Control_Monad_State_Trans_compose)($__global_Control_Monad_State_Trans_mapStateT, ($dictMonadReader)->local), "MonadAsk0" => (function() use ($monadAskStateT1) {
...
$monadStateT1 = ($__global_Control_Monad_State_Trans_monadStateT)($Monad0);
    $__res = (object)["liftEffect" => ($__global_Control_Monad_State_Trans_compose)(($__global_Control_Monad_State_Trans_lift)($Monad0), ($dictMonadEffect)->liftEffect), "Monad0" => (function() use ($monadStateT1) {
  $__fn = function($__dollar____unused) use ($monadStateT1, &$__fn) {
  $__num = func_num_args();
  if ($__num < 1) {
    return phpurs_curry_fallback($__fn, func_get_args(), 1);
...
$monadStateT1 = ($__global_Control_Monad_State_Trans_monadStateT)($Monad1);
    $__res = (object)["tell" => ($__global_Control_Monad_State_Trans_compose)(($__global_Control_Monad_State_Trans_lift)($Monad1), ($dictMonadTell)->tell), "Semigroup0" => (function() use (&$Semigroup0) {
...
$monadStateT1 = ($__global_Control_Monad_State_Trans_monadStateT)($Monad0);
    $__res = (object)["liftST" => ($__global_Control_Monad_State_Trans_compose)(($__global_Control_Monad_State_Trans_lift)($Monad0), ($dictMonadST)->liftST), "Monad0" => (function() use ($monadStateT1) {
  $__fn = function($__dollar____unused) use ($monadStateT1, &$__fn) {
  $__num = func_num_args();
  if ($__num < 1) {
    return phpurs_curry_fallback($__fn, func_get_args(), 1);
...
$semigroupStateT2 = ($semigroupStateT1)((($dictMonoid)->Semigroup0)($__global_Prim_undefined));
    $__res = (object)["mempty" => ($pure)(($dictMonoid)->mempty), "Semigroup0" => (function() use ($semigroupStateT2) {
