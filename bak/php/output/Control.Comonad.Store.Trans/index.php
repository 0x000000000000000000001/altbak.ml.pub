...
if (!function_exists(__NAMESPACE__ . '\\phpurs_eval_thunk')) {
  function phpurs_eval_thunk($id) {
    ...
    switch ($id) {
      ...
      case 'Control_Comonad_Store_Trans_newtypeStoreT': $v = (object)["Coercible0" => (function() {
...
$__global_Prim_undefined = ($GLOBALS['Prim_undefined'] ?? \Prim\phpurs_eval_thunk('Prim_undefined'));
  ...
  return $__fn;
      ...
      case 'Control_Comonad_Store_Trans_comonadTransStoreT': $v = (object)["lower" => (function() {
...
$map = ($dictFunctor)->map;
    $__res = (object)["map" => (function() use ($map, $__global_Control_Comonad_Store_Trans_composeFlipped) {
...
$functorStoreT1 = ($__global_Control_Comonad_Store_Trans_functorStoreT)((($dictExtend)->Functor0)($__global_Prim_undefined));
    $__res = (object)["extend" => (function() use ($extend) {
