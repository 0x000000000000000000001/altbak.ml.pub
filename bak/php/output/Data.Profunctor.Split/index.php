...
$__global_Data_Profunctor_Split_compose = ($GLOBALS['Data_Profunctor_Split_compose'] ?? \Data\Profunctor\Split\phpurs_eval_thunk('Data_Profunctor_Split_compose'));
    $__res = ($__global_Data_Profunctor_Split_unSplit)((function() use ($__global_Data_Profunctor_Split_split, $__global_Data_Profunctor_Split_compose, $f, $g) {
...
$__global_Data_Profunctor_Split_split = ($GLOBALS['Data_Profunctor_Split_split'] ?? \Data\Profunctor\Split\phpurs_eval_thunk('Data_Profunctor_Split_split'));
$__global_Data_Profunctor_Split_compose = ($GLOBALS['Data_Profunctor_Split_compose'] ?? \Data\Profunctor\Split\phpurs_eval_thunk('Data_Profunctor_Split_compose'));
    $__res = ($__global_Data_Profunctor_Split_unSplit)((function() use ($__global_Data_Profunctor_Split_split, $__global_Data_Profunctor_Split_compose, $f) {
...
$f1 = $__case_0;
$e = $__case_1;
return ($__global_Unsafe_Coerce_unsafeCoerce)((function() use ($f1) {
...
$__global_Unsafe_Coerce_unsafeCoerce = ($GLOBALS['Unsafe_Coerce_unsafeCoerce'] ?? \Unsafe\Coerce\phpurs_eval_thunk('Unsafe_Coerce_unsafeCoerce'));
    $__res = ($__global_Unsafe_Coerce_unsafeCoerce)(((function() {
...
$__global_Data_Profunctor_Split_compose = ($GLOBALS['Data_Profunctor_Split_compose'] ?? \Data\Profunctor\Split\phpurs_eval_thunk('Data_Profunctor_Split_compose'));
$__global_Data_Profunctor_Split_split = ($GLOBALS['Data_Profunctor_Split_split'] ?? \Data\Profunctor\Split\phpurs_eval_thunk('Data_Profunctor_Split_split'));
    $__res = ($__global_Data_Profunctor_Split_unSplit)((function() use ($__global_Data_Profunctor_Split_compose, $__global_Data_Profunctor_Split_split, $nat) {
