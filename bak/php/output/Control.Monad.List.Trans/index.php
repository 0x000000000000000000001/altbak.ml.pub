...
$__global_Prim_undefined = ($GLOBALS['Prim_undefined'] ?? \Prim\phpurs_eval_thunk('Prim_undefined'));
  ...
  return $__fn;
      ...
      case 'Control_Monad_List_Trans_monadTransListT': $v = (object)["lift" => (function() {
...
return (function() use ($__global_Data_Lazy_defer, $dictMonad, $map2) {
...
return (function() use ($pure1, $__global_Data_Lazy_force, $dictMonad, $bind) {
  $__body = function($v) use ($pure1, $__global_Data_Lazy_force, $dictMonad, $bind) {
...
throw new \Exception("Pattern match failure");
  ...
  $__fn = function($v) use ($pure1, $__global_Data_Lazy_force, $dictMonad, $bind, $__body, &$__fn) {
  $__num = func_num_args();
  if ($__num < 1) {
    return phpurs_curry_fallback($__fn, func_get_args(), 1);
  }
...
return (function() use ($__global_Control_Monad_List_Trans_map1, $dictApplicative, $stepMap1) {
  $__fn = function($f) use ($__global_Control_Monad_List_Trans_map1, $dictApplicative, $stepMap1, &$__fn) {
  $__num = func_num_args();
  if ($__num < 1) {
    return phpurs_curry_fallback($__fn, func_get_args(), 1);
  }
...
$nil1 = ($__global_Control_Monad_List_Trans_nil)($dictApplicative);
$stepMap1 = ($__global_Control_Monad_List_Trans_stepMap)((((($dictApplicative)->Apply0)($__global_Prim_undefined))->Functor0)($__global_Prim_undefined));
return (function() use ($nil1, $__global_Control_Monad_List_Trans_map1, $dictApplicative, $stepMap1) {
  $__body = function($v, $v1) use ($nil1, $__global_Control_Monad_List_Trans_map1, $dictApplicative, $stepMap1) {
...
$n = $__case_0;
$fa = $__case_1;
$f = (function() use ($__global_Control_Monad_List_Trans_map1, $__global_Control_Monad_List_Trans_take, $dictApplicative, $n) {
  $__body = function($v2) use ($__global_Control_Monad_List_Trans_map1, $__global_Control_Monad_List_Trans_take, $dictApplicative, $n) {
    $__case_0 = $v2;
    switch (($__case_0)->tag) {
case "Yield":
$a = ($__case_0)->v0;
...
return ((function() {
  ...
  return $__fn;
})())($a, ($__global_Control_Monad_List_Trans_map1)(($__global_Control_Monad_List_Trans_take)($dictApplicative, ($n - 1)), $s));
break;
case "Skip":
$s = ($__case_0)->v0;
return ((function() {
...
break;
  ...
  $__fn = function($v2) use ($__global_Control_Monad_List_Trans_map1, $__global_Control_Monad_List_Trans_take, $dictApplicative, $n, $__body, &$__fn) {
  $__num = func_num_args();
  if ($__num < 1) {
    return phpurs_curry_fallback($__fn, func_get_args(), 1);
  }
...
break;
  ...
  $__fn = function($v, $v1 = null) use ($nil1, $__global_Control_Monad_List_Trans_map1, $dictApplicative, $stepMap1, $__body, &$__fn) {
  $__num = func_num_args();
  if ($__num < 2) {
...
$bind = ($Bind1)->bind;
$uncons1 = ($__global_Control_Monad_List_Trans_uncons)($dictMonad);
return (function() use ($pure1, $nil1, $map2, $__global_Data_Function_flip, $prepend__prime__1, $__global_Data_Lazy_defer, $dictMonad, $wrapEffect1, $bind, $uncons1) {
  $__fn = function($f) use ($pure1, $nil1, $map2, $__global_Data_Function_flip, $prepend__prime__1, $__global_Data_Lazy_defer, $dictMonad, $wrapEffect1, $bind, $uncons1, &$__fn) {
  $__num = func_num_args();
  if ($__num < 1) {
    return phpurs_curry_fallback($__fn, func_get_args(), 1);
  }
...
while (true) {
$stepMap1 = ($__global_Control_Monad_List_Trans_stepMap)($dictFunctor);
return (object)["map" => (function() use ($__global_Control_Monad_List_Trans_map1, $dictFunctor, $stepMap1) {
...
$g = (function() use ($f, $__global_Control_Monad_List_Trans_map1, $__global_Control_Monad_List_Trans_functorListT, $dictFunctor) {
  $__body = function($v) use ($f, $__global_Control_Monad_List_Trans_map1, $__global_Control_Monad_List_Trans_functorListT, $dictFunctor) {
    $__case_0 = $v;
    switch (($__case_0)->tag) {
case "Yield":
$a = ($__case_0)->v0;
...
return ((function() {
  ...
  return $__fn;
})())(($f)($a), ($__global_Control_Monad_List_Trans_map1)(((($__global_Control_Monad_List_Trans_functorListT)($dictFunctor))->map)($f), $s));
break;
case "Skip":
$s = ($__case_0)->v0;
return ((function() {
  ...
  return $__fn;
})())(($__global_Control_Monad_List_Trans_map1)(((($__global_Control_Monad_List_Trans_functorListT)($dictFunctor))->map)($f), $s));
break;
case "Done":
return ($GLOBALS['__phpurs_data0_Done'] ??= new Phpurs_Data0("Done"));
break;
...
break;
  ...
  $__fn = function($v) use ($f, $__global_Control_Monad_List_Trans_map1, $__global_Control_Monad_List_Trans_functorListT, $dictFunctor, $__body, &$__fn) {
  $__num = func_num_args();
  if ($__num < 1) {
    return phpurs_curry_fallback($__fn, func_get_args(), 1);
  }
...
$pure1 = ((((($dictMonadRec)->Monad0)($__global_Prim_undefined))->Applicative0)($__global_Prim_undefined))->pure;
    $__res = ($__global_Control_Monad_List_Trans_foldlRec__prime__)($dictMonadRec, (function() use ($pure1, $__global_Data_Unit_unit) {
...
$__global_Data_Unit_unit = ($GLOBALS['Data_Unit_unit'] ?? \Data\Unit\phpurs_eval_thunk('Data_Unit_unit'));
$pure1 = ((($dictMonad)->Applicative0)($__global_Prim_undefined))->pure;
    $__res = ($__global_Control_Monad_List_Trans_foldl__prime__)($dictMonad, (function() use ($pure1, $__global_Data_Unit_unit) {
  $__fn = function($v, $v1 = null) use ($pure1, $__global_Data_Unit_unit, &$__fn) {
  $__num = func_num_args();
  if ($__num < 2) {
    if ($__num === 1) return function($v1) use ($v, &$__fn) { return $__fn($v, $v1); };
...
$stepMap1 = ($__global_Control_Monad_List_Trans_stepMap)((((($dictApplicative)->Apply0)($__global_Prim_undefined))->Functor0)($__global_Prim_undefined));
return (function() use ($__global_Control_Monad_List_Trans_map1, $dictApplicative, $stepMap1) {
  $__body = function($v, $v1) use ($__global_Control_Monad_List_Trans_map1, $dictApplicative, $stepMap1) {
...
$n = $__case_0;
$fa = $__case_1;
$f = (function() use ($__global_Control_Monad_List_Trans_map1, $__global_Control_Monad_List_Trans_drop, $dictApplicative, $n) {
  $__body = function($v2) use ($__global_Control_Monad_List_Trans_map1, $__global_Control_Monad_List_Trans_drop, $dictApplicative, $n) {
    $__case_0 = $v2;
    switch (($__case_0)->tag) {
case "Yield":
$s = ($__case_0)->v1;
return ((function() {
  ...
  return $__fn;
})())(($__global_Control_Monad_List_Trans_map1)(($__global_Control_Monad_List_Trans_drop)($dictApplicative, ($n - 1)), $s));
break;
case "Skip":
$s = ($__case_0)->v0;
return ((function() {
...
break;
  ...
  $__fn = function($v2) use ($__global_Control_Monad_List_Trans_map1, $__global_Control_Monad_List_Trans_drop, $dictApplicative, $n, $__body, &$__fn) {
  $__num = func_num_args();
  if ($__num < 1) {
    return phpurs_curry_fallback($__fn, func_get_args(), 1);
  }
...
break;
  ...
  $__fn = function($v, $v1 = null) use ($__global_Control_Monad_List_Trans_map1, $dictApplicative, $stepMap1, $__body, &$__fn) {
  $__num = func_num_args();
  if ($__num < 2) {
    if ($__num === 1) return function($v1) use ($v, &$__fn) { return $__fn($v, $v1); };
    return phpurs_curry_fallback($__fn, func_get_args(), 2);
...
while (true) {
return (object)["append" => ($__global_Control_Monad_List_Trans_concat)($dictApplicative)];
};
    $__res = null;
    return 1 < $__num ? $__res(...array_slice(func_get_args(), 1)) : $__res;
}
...
while (true) {
$stepMap1 = ($__global_Control_Monad_List_Trans_stepMap)((((($dictApplicative)->Apply0)($__global_Prim_undefined))->Functor0)($__global_Prim_undefined));
return (function() use ($__global_Control_Monad_List_Trans_map1, $__global_Control_Monad_List_Trans_semigroupListT, $dictApplicative, $__global_Data_Lazy_defer, $__global_Data_Function_const, $stepMap1) {
...
$f = (function() use ($__global_Control_Monad_List_Trans_map1, $__global_Control_Monad_List_Trans_semigroupListT, $dictApplicative, $y, $__global_Data_Lazy_defer, $__global_Data_Function_const) {
  $__body = function($v) use ($__global_Control_Monad_List_Trans_map1, $__global_Control_Monad_List_Trans_semigroupListT, $dictApplicative, $y, $__global_Data_Lazy_defer, $__global_Data_Function_const) {
    $__case_0 = $v;
    switch (($__case_0)->tag) {
case "Yield":
$a = ($__case_0)->v0;
...
return ((function() {
  ...
  return $__fn;
})())($a, ($__global_Control_Monad_List_Trans_map1)((function() use ($__global_Control_Monad_List_Trans_semigroupListT, $dictApplicative, $y) {
  $__fn = function($v1) use ($__global_Control_Monad_List_Trans_semigroupListT, $dictApplicative, $y, &$__fn) {
  $__num = func_num_args();
  if ($__num < 1) {
    return phpurs_curry_fallback($__fn, func_get_args(), 1);
  }
...
return ((function() {
  ...
  return $__fn;
})())(($__global_Control_Monad_List_Trans_map1)((function() use ($__global_Control_Monad_List_Trans_semigroupListT, $dictApplicative, $y) {
  $__fn = function($v1) use ($__global_Control_Monad_List_Trans_semigroupListT, $dictApplicative, $y, &$__fn) {
  $__num = func_num_args();
  if ($__num < 1) {
    return phpurs_curry_fallback($__fn, func_get_args(), 1);
...
break;
  ...
  $__fn = function($v) use ($__global_Control_Monad_List_Trans_map1, $__global_Control_Monad_List_Trans_semigroupListT, $dictApplicative, $y, $__global_Data_Lazy_defer, $__global_Data_Function_const, $__body, &$__fn) {
  $__num = func_num_args();
  if ($__num < 1) {
    return phpurs_curry_fallback($__fn, func_get_args(), 1);
  }
...
$semigroupListT1 = ($__global_Control_Monad_List_Trans_semigroupListT)($dictApplicative);
    $__res = (object)["mempty" => ($__global_Control_Monad_List_Trans_nil)($dictApplicative), "Semigroup0" => (function() use ($semigroupListT1) {
...
while (true) {
return (object)["Applicative0" => (function() use ($__global_Control_Monad_List_Trans_applicativeListT, $dictMonad) {
  $__fn = function($__dollar____unused) use ($__global_Control_Monad_List_Trans_applicativeListT, $dictMonad, &$__fn) {
  $__num = func_num_args();
  if ($__num < 1) {
    return phpurs_curry_fallback($__fn, func_get_args(), 1);
  }
  ...
  return $__fn;
})(), "Bind1" => (function() use ($__global_Control_Monad_List_Trans_bindListT, $dictMonad) {
  $__fn = function($__dollar____unused) use ($__global_Control_Monad_List_Trans_bindListT, $dictMonad, &$__fn) {
  $__num = func_num_args();
  if ($__num < 1) {
    return phpurs_curry_fallback($__fn, func_get_args(), 1);
  }
...
return (object)["bind" => (function() use ($append, $dictMonad, $__global_Control_Monad_List_Trans_map1, $stepMap1) {
...
$__global_Control_Monad_List_Trans_bindListT = ($GLOBALS['Control_Monad_List_Trans_bindListT'] ?? \Control\Monad\List\Trans\phpurs_eval_thunk('Control_Monad_List_Trans_bindListT'));
$g = (function() use ($append, $f, $__global_Control_Monad_List_Trans_bindListT, $dictMonad, $__global_Control_Monad_List_Trans_map1) {
  $__body = function($v) use ($append, $f, $__global_Control_Monad_List_Trans_bindListT, $dictMonad, $__global_Control_Monad_List_Trans_map1) {
    $__case_0 = $v;
    switch (($__case_0)->tag) {
case "Yield":
$a = ($__case_0)->v0;
$s = ($__case_0)->v1;
$h = (function() use ($append, $f, $a, $__global_Control_Monad_List_Trans_bindListT, $dictMonad) {
  $__fn = function($s__prime__) use ($append, $f, $a, $__global_Control_Monad_List_Trans_bindListT, $dictMonad, &$__fn) {
  $__num = func_num_args();
  if ($__num < 1) {
    return phpurs_curry_fallback($__fn, func_get_args(), 1);
  }
...
return ((function() {
  ...
  return $__fn;
})())(($__global_Control_Monad_List_Trans_map1)((function() use ($__global_Control_Monad_List_Trans_bindListT, $dictMonad, $f) {
  $__fn = function($v1) use ($__global_Control_Monad_List_Trans_bindListT, $dictMonad, $f, &$__fn) {
  $__num = func_num_args();
  if ($__num < 1) {
    return phpurs_curry_fallback($__fn, func_get_args(), 1);
  }
...
break;
  ...
  $__fn = function($v) use ($append, $f, $__global_Control_Monad_List_Trans_bindListT, $dictMonad, $__global_Control_Monad_List_Trans_map1, $__body, &$__fn) {
  $__num = func_num_args();
  if ($__num < 1) {
    return phpurs_curry_fallback($__fn, func_get_args(), 1);
  }
  ...
  return $__fn;
})(), "Apply0" => (function() use ($__global_Control_Monad_List_Trans_applyListT, $dictMonad) {
  $__fn = function($__dollar____unused) use ($__global_Control_Monad_List_Trans_applyListT, $dictMonad, &$__fn) {
  $__num = func_num_args();
  if ($__num < 1) {
    return phpurs_curry_fallback($__fn, func_get_args(), 1);
  }
...
return (object)["apply" => ($__global_Control_Monad_ap)(($__global_Control_Monad_List_Trans_monadListT)($dictMonad)), "Functor0" => (function() use ($functorListT1) {
...
$__global_Control_Monad_List_Trans_applyListT = ($GLOBALS['Control_Monad_List_Trans_applyListT'] ?? \Control\Monad\List\Trans\phpurs_eval_thunk('Control_Monad_List_Trans_applyListT'));
while (true) {
return (object)["pure" => ($__global_Control_Monad_List_Trans_singleton)((($dictMonad)->Applicative0)($__global_Prim_undefined)), "Apply0" => (function() use ($__global_Control_Monad_List_Trans_applyListT, $dictMonad) {
  $__fn = function($__dollar____unused) use ($__global_Control_Monad_List_Trans_applyListT, $dictMonad, &$__fn) {
  $__num = func_num_args();
  if ($__num < 1) {
    return phpurs_curry_fallback($__fn, func_get_args(), 1);
...
$monadListT1 = ($__global_Control_Monad_List_Trans_monadListT)($Monad0);
    $__res = (object)["liftEffect" => ($__global_Control_Monad_List_Trans_compose)(($__global_Control_Monad_List_Trans_lift)($Monad0), ($dictMonadEffect)->liftEffect), "Monad0" => (function() use ($monadListT1) {
...
$monadListT1 = ($__global_Control_Monad_List_Trans_monadListT)($Monad0);
    $__res = (object)["liftST" => ($__global_Control_Monad_List_Trans_compose)(($__global_Control_Monad_List_Trans_lift)($Monad0), ($dictMonadST)->liftST), "Monad0" => (function() use ($monadListT1) {
  $__fn = function($__dollar____unused) use ($monadListT1, &$__fn) {
  $__num = func_num_args();
  if ($__num < 1) {
    return phpurs_curry_fallback($__fn, func_get_args(), 1);
...
$functorListT1 = ($__global_Control_Monad_List_Trans_functorListT)((((($dictApplicative)->Apply0)($__global_Prim_undefined))->Functor0)($__global_Prim_undefined));
    $__res = (object)["alt" => ($__global_Control_Monad_List_Trans_concat)($dictApplicative), "Functor0" => (function() use ($functorListT1) {
  $__fn = function($__dollar____unused) use ($functorListT1, &$__fn) {
  $__num = func_num_args();
  if ($__num < 1) {
    return phpurs_curry_fallback($__fn, func_get_args(), 1);
...
$altListT1 = ($__global_Control_Monad_List_Trans_altListT)($Applicative0);
    $__res = (object)["empty" => ($__global_Control_Monad_List_Trans_nil)($Applicative0), "Alt0" => (function() use ($altListT1) {
