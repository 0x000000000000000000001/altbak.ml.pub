...
$f = $__case_0;
$g = $__case_1;
return ($__global_Data_Op_compose)($g, $f);
} else {
throw new \Exception("Pattern match failure");
  ...
  return $__fn;
      ...
      case 'Data_Op_newtypeOp': $v = (object)["Coercible0" => (function() {
...
$__global_Prim_undefined = ($GLOBALS['Prim_undefined'] ?? \Prim\phpurs_eval_thunk('Prim_undefined'));
  ...
  return $__fn;
      ...
      case 'Data_Op_contravariantOp': $v = (object)["cmap" => (function() {
  $__body = function($f, $v) {
    $__global_Data_Op_compose = ($GLOBALS['Data_Op_compose'] ?? \Data\Op\phpurs_eval_thunk('Data_Op_compose'));
    $__case_0 = $f;
    $__case_1 = $v;
...
$f1 = $__case_0;
$g = $__case_1;
return ($__global_Data_Op_compose)($g, $f1);
} else {
throw new \Exception("Pattern match failure");
};
  };
...
$__global_Data_Op_semigroupoidOp = ($GLOBALS['Data_Op_semigroupoidOp'] ?? \Data\Op\phpurs_eval_thunk('Data_Op_semigroupoidOp'));
    $__res = $__global_Data_Op_semigroupoidOp;
  return $__num > 1 ? $__res(...array_slice(func_get_args(), 1)) : $__res;
  };
  return $__fn;
})()]; break;
...
// Data_Op_Op
function Data_Op_Op($x) {
  $__num = func_num_args();
  $__fn = __NAMESPACE__ . '\\' . 'Data_Op_Op';
  if ($__num < 1) {
    return phpurs_curry_fallback($__fn, func_get_args(), 1);
  }
    $__res = $x;
...
$GLOBALS['Data_Op_Op'] = __NAMESPACE__ . '\\Data_Op_Op';


// Data_Op_semigroupOp
function Data_Op_semigroupOp($dictSemigroup) {
  $__num = func_num_args();
  $__fn = __NAMESPACE__ . '\\' . 'Data_Op_semigroupOp';
  if ($__num < 1) {
    return phpurs_curry_fallback($__fn, func_get_args(), 1);
  }
...
// Data_Op_monoidOp
function Data_Op_monoidOp($dictMonoid) {
  $__num = func_num_args();
  $__fn = __NAMESPACE__ . '\\' . 'Data_Op_monoidOp';
  if ($__num < 1) {
    return phpurs_curry_fallback($__fn, func_get_args(), 1);
  }
