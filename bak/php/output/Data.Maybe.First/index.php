...
$__global_Data_Maybe_First_semigroupFirst = ($GLOBALS['Data_Maybe_First_semigroupFirst'] ?? \Data\Maybe\First\phpurs_eval_thunk('Data_Maybe_First_semigroupFirst'));
  ...
  return $__fn;
      ...
      case 'Data_Maybe_First_altFirst': $v = (object)["alt" => (($GLOBALS['Data_Maybe_First_semigroupFirst'] ?? \Data\Maybe\First\phpurs_eval_thunk('Data_Maybe_First_semigroupFirst')))->append, "Functor0" => (function() {
  $__fn = function($__dollar____unused) use (&$__fn) {
  $__num = func_num_args();
  if ($__num < 1) {
    return phpurs_curry_fallback($__fn, func_get_args(), 1);
...
$__global_Data_Maybe_functorMaybe = ($GLOBALS['Data_Maybe_functorMaybe'] ?? \Data\Maybe\phpurs_eval_thunk('Data_Maybe_functorMaybe'));
  ...
  return $__fn;
      ...
      case 'Data_Maybe_First_plusFirst': $v = (object)["empty" => (($GLOBALS['Data_Maybe_First_monoidFirst'] ?? \Data\Maybe\First\phpurs_eval_thunk('Data_Maybe_First_monoidFirst')))->mempty, "Alt0" => (function() {
  $__fn = function($__dollar____unused) use (&$__fn) {
  $__num = func_num_args();
  if ($__num < 1) {
    return phpurs_curry_fallback($__fn, func_get_args(), 1);
