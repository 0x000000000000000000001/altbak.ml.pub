...
if (!function_exists(__NAMESPACE__ . '\\phpurs_eval_thunk')) {
  function phpurs_eval_thunk($id) {
    ...
    switch ($id) {
      ...
      case 'Data_Ord_Min_newtypeMin': $v = (object)["Coercible0" => function($__dollar____unused) {
  $__num = func_num_args();
...
function Data_Ord_Min_semigroupMin($dictOrd) {
  ...
  $__res = (object)["append" => (function() use ($min, &$__fn) {
...
function Data_Ord_Min_monoidMin($dictBounded) {
  ...
  $__res = (object)["mempty" => ($dictBounded)->top, "Semigroup0" => function($__dollar____unused) use ($semigroupMin1) {
  $__num = func_num_args();
  $__res = $semigroupMin1;
  goto __end;;
  __end:
...
throw new \Exception("Pattern match failure");
  ...
  return $__fn;
})(), "Eq0" => function($__dollar____unused) use ($eqMin1) {
  $__num = func_num_args();
  $__res = $eqMin1;
  goto __end;;
  __end:
