...
throw new \Exception("Pattern match failure");
  ...
  return $__fn;
      ...
      case 'Data_Const_newtypeConst': $v = (object)["Coercible0" => (function() {
...
throw new \Exception("Pattern match failure");
  ...
  return $__fn;
      ...
      case 'Data_Const_invariantConst': $v = (object)["imap" => (($GLOBALS['Data_Functor_Invariant_imapF'] ?? \Data\Functor\Invariant\phpurs_eval_thunk('Data_Functor_Invariant_imapF')))(($GLOBALS['Data_Const_functorConst'] ?? \Data\Const\phpurs_eval_thunk('Data_Const_functorConst')))]; break;
...
$eq = ($dictEq)->eq;
    $__res = (object)["eq1" => (function() use ($eq) {
...
$eq1Const1 = ($__global_Data_Const_eq1Const)((($dictOrd)->Eq0)($__global_Prim_undefined));
    $__res = (object)["compare1" => (function() use ($compare) {
...
throw new \Exception("Pattern match failure");
  ...
  return $__fn;
})(), "Functor0" => (function() use ($__global_Data_Const_functorConst) {
  $__fn = function($__dollar____unused) use ($__global_Data_Const_functorConst, &$__fn) {
  $__num = func_num_args();
  if ($__num < 1) {
    return phpurs_curry_fallback($__fn, func_get_args(), 1);
  }
...
$applyConst1 = ($__global_Data_Const_applyConst)((($dictMonoid)->Semigroup0)($__global_Prim_undefined));
    $__res = (object)["pure" => (function() use ($mempty) {
