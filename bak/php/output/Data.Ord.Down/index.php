...
if (!function_exists(__NAMESPACE__ . '\\phpurs_eval_thunk')) {
  function phpurs_eval_thunk($id) {
    ...
    switch ($id) {
      ...
      case 'Data_Ord_Down_newtypeDown': $v = (object)["Coercible0" => function($__dollar____unused) {
  $__num = func_num_args();
...
function Data_Ord_Down_ordDown($dictOrd) {
  ...
  $__res = (object)["compare" => (function() use ($__global_Data_Ordering_invert, $compare, &$__fn) {
  $__fn = function($v, $v1 = null) use ($__global_Data_Ordering_invert, $compare, &$__fn) {
  $__num = func_num_args();
  if ($__num < 2) {
...
$x = $__case_0;
$y = $__case_1;
$__res = ($__global_Data_Ordering_invert)(($compare)($x, $y));
goto __end;;
} else {
throw new \Exception("Pattern match failure");
};
  ...
  return $__fn;
})(), "Eq0" => function($__dollar____unused) use ($eqDown1) {
  $__num = func_num_args();
  $__res = $eqDown1;
  goto __end;;
  __end:
...
function Data_Ord_Down_boundedDown($dictBounded) {
  ...
  $__res = (object)["top" => ($dictBounded)->bottom, "bottom" => ($dictBounded)->top, "Ord0" => function($__dollar____unused) use ($ordDown1) {
  $__num = func_num_args();
  $__res = $ordDown1;
  goto __end;;
  __end:
