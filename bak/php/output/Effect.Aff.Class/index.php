...
if (!function_exists(__NAMESPACE__ . '\\phpurs_eval_thunk')) {
  function phpurs_eval_thunk($id) {
    ...
    switch ($id) {
      ...
      case 'Effect_Aff_Class_monadAffAff': $v = (object)["liftAff" => (($GLOBALS['Control_Category_categoryFn'] ?? \Control\Category\phpurs_eval_thunk('Control_Category_categoryFn')))->identity, "MonadEffect0" => (function() {
...
$monadEffectContT = ($__global_Control_Monad_Cont_Trans_monadEffectContT)($MonadEffect0);
    $__res = (object)["liftAff" => ($__global_Effect_Aff_Class_compose)(($__global_Effect_Aff_Class_lift)((($MonadEffect0)->Monad0)($__global_Prim_undefined)), ($dictMonadAff)->liftAff), "MonadEffect0" => (function() use ($monadEffectContT) {
...
$monadEffectExceptT = ($__global_Control_Monad_Except_Trans_monadEffectExceptT)($MonadEffect0);
    $__res = (object)["liftAff" => ($__global_Effect_Aff_Class_compose)(($__global_Effect_Aff_Class_lift1)((($MonadEffect0)->Monad0)($__global_Prim_undefined)), ($dictMonadAff)->liftAff), "MonadEffect0" => (function() use ($monadEffectExceptT) {
...
$monadEffectListT = ($__global_Control_Monad_List_Trans_monadEffectListT)($MonadEffect0);
    $__res = (object)["liftAff" => ($__global_Effect_Aff_Class_compose)(($__global_Effect_Aff_Class_lift2)((($MonadEffect0)->Monad0)($__global_Prim_undefined)), ($dictMonadAff)->liftAff), "MonadEffect0" => (function() use ($monadEffectListT) {
...
$monadEffectMaybe = ($__global_Control_Monad_Maybe_Trans_monadEffectMaybe)($MonadEffect0);
    $__res = (object)["liftAff" => ($__global_Effect_Aff_Class_compose)(($__global_Effect_Aff_Class_lift3)((($MonadEffect0)->Monad0)($__global_Prim_undefined)), ($dictMonadAff)->liftAff), "MonadEffect0" => (function() use ($monadEffectMaybe) {
...
$liftAff1 = ($dictMonadAff)->liftAff;
    $__res = (function() use ($__global_Control_Monad_RWS_Trans_monadEffectRWS, &$MonadEffect0, $__global_Effect_Aff_Class_compose, $__global_Control_Monad_RWS_Trans_monadTransRWST, &$Monad0, $liftAff1) {
  $__fn = function($dictMonoid) use ($__global_Control_Monad_RWS_Trans_monadEffectRWS, &$MonadEffect0, $__global_Effect_Aff_Class_compose, $__global_Control_Monad_RWS_Trans_monadTransRWST, &$Monad0, $liftAff1, &$__fn) {
  $__num = func_num_args();
  if ($__num < 1) {
    return phpurs_curry_fallback($__fn, func_get_args(), 1);
  }
$monadEffectRWS = ($__global_Control_Monad_RWS_Trans_monadEffectRWS)($dictMonoid, $MonadEffect0);
    $__res = (object)["liftAff" => ($__global_Effect_Aff_Class_compose)(((($__global_Control_Monad_RWS_Trans_monadTransRWST)($dictMonoid))->lift)($Monad0), $liftAff1), "MonadEffect0" => (function() use ($monadEffectRWS) {
...
$monadEffectReader = ($__global_Control_Monad_Reader_Trans_monadEffectReader)($MonadEffect0);
    $__res = (object)["liftAff" => ($__global_Effect_Aff_Class_compose)(($__global_Effect_Aff_Class_lift4)((($MonadEffect0)->Monad0)($__global_Prim_undefined)), ($dictMonadAff)->liftAff), "MonadEffect0" => (function() use ($monadEffectReader) {
...
$monadEffectState = ($__global_Control_Monad_State_Trans_monadEffectState)($MonadEffect0);
    $__res = (object)["liftAff" => ($__global_Effect_Aff_Class_compose)(($__global_Effect_Aff_Class_lift5)((($MonadEffect0)->Monad0)($__global_Prim_undefined)), ($dictMonadAff)->liftAff), "MonadEffect0" => (function() use ($monadEffectState) {
...
$Monad0 = (($MonadEffect0)->Monad0)($__global_Prim_undefined);
$liftAff1 = ($dictMonadAff)->liftAff;
    $__res = (function() use ($__global_Control_Monad_Writer_Trans_monadEffectWriter, &$MonadEffect0, $__global_Effect_Aff_Class_compose, $__global_Control_Monad_Writer_Trans_monadTransWriterT, &$Monad0, $liftAff1) {
  $__fn = function($dictMonoid) use ($__global_Control_Monad_Writer_Trans_monadEffectWriter, &$MonadEffect0, $__global_Effect_Aff_Class_compose, $__global_Control_Monad_Writer_Trans_monadTransWriterT, &$Monad0, $liftAff1, &$__fn) {
  $__num = func_num_args();
  if ($__num < 1) {
    return phpurs_curry_fallback($__fn, func_get_args(), 1);
  }
$monadEffectWriter = ($__global_Control_Monad_Writer_Trans_monadEffectWriter)($dictMonoid, $MonadEffect0);
    $__res = (object)["liftAff" => ($__global_Effect_Aff_Class_compose)(((($__global_Control_Monad_Writer_Trans_monadTransWriterT)($dictMonoid))->lift)($Monad0), $liftAff1), "MonadEffect0" => (function() use ($monadEffectWriter) {
