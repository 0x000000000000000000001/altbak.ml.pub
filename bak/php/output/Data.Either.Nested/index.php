...
case "Right":
$_9 = ($__case_0)->v0;
return ($__global_Data_Void_absurd)($_9);
break;
default:
...
case "Right":
$_8 = ($__case_0)->v0;
return ($__global_Data_Void_absurd)($_8);
break;
default:
throw new \Exception("Pattern match failure");
break;
...
case "Right":
$_7 = ($__case_0)->v0;
return ($__global_Data_Void_absurd)($_7);
break;
default:
throw new \Exception("Pattern match failure");
break;
...
case "Right":
$_6 = ($__case_0)->v0;
return ($__global_Data_Void_absurd)($_6);
break;
default:
throw new \Exception("Pattern match failure");
break;
...
case "Right":
$_5 = ($__case_0)->v0;
return ($__global_Data_Void_absurd)($_5);
break;
default:
throw new \Exception("Pattern match failure");
break;
...
case "Right":
$_4 = ($__case_0)->v0;
return ($__global_Data_Void_absurd)($_4);
break;
default:
throw new \Exception("Pattern match failure");
break;
...
case "Right":
$_3 = ($__case_0)->v0;
return ($__global_Data_Void_absurd)($_3);
break;
default:
throw new \Exception("Pattern match failure");
break;
...
case "Right":
$_2 = ($__case_0)->v0;
return ($__global_Data_Void_absurd)($_2);
break;
default:
throw new \Exception("Pattern match failure");
break;
...
case "Right":
$_10 = ($__case_0)->v0;
return ($__global_Data_Void_absurd)($_10);
break;
default:
throw new \Exception("Pattern match failure");
break;
...
case "Right":
$_1 = ($__case_0)->v0;
return ($__global_Data_Void_absurd)($_1);
break;
default:
throw new \Exception("Pattern match failure");
break;
