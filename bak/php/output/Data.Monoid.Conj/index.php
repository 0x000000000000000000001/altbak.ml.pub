...
throw new \Exception("Pattern match failure");
  ...
  return $__fn;
      ...
      case 'Data_Monoid_Conj_eq1Conj': $v = (object)["eq1" => (function() {
  ...
  return $__fn;
      ...
      case 'Data_Monoid_Conj_ord1Conj': $v = (object)["compare1" => (function() {
...
$__global_Data_Monoid_Conj_applyConj = ($GLOBALS['Data_Monoid_Conj_applyConj'] ?? \Data\Monoid\Conj\phpurs_eval_thunk('Data_Monoid_Conj_applyConj'));
  ...
  return $__fn;
      ...
      case 'Data_Monoid_Conj_applicativeConj': $v = (object)["pure" => ($GLOBALS['Data_Monoid_Conj_Conj'] ?? \Data\Monoid\Conj\phpurs_eval_thunk('Data_Monoid_Conj_Conj')), "Apply0" => (function() {
  $__fn = function($__dollar____unused) use (&$__fn) {
  $__num = func_num_args();
  if ($__num < 1) {
    return phpurs_curry_fallback($__fn, func_get_args(), 1);
...
$__global_Data_Monoid_Conj_applyConj = ($GLOBALS['Data_Monoid_Conj_applyConj'] ?? \Data\Monoid\Conj\phpurs_eval_thunk('Data_Monoid_Conj_applyConj'));
  ...
  return $__fn;
      ...
      case 'Data_Monoid_Conj_monadConj': $v = (object)["Applicative0" => (function() {
  $__fn = function($__dollar____unused) use (&$__fn) {
  $__num = func_num_args();
  if ($__num < 1) {
    return phpurs_curry_fallback($__fn, func_get_args(), 1);
...
$semigroupConj1 = ($__global_Data_Monoid_Conj_semigroupConj)($dictHeytingAlgebra);
    $__res = (object)["mempty" => ($dictHeytingAlgebra)->tt, "Semigroup0" => (function() use ($semigroupConj1) {
