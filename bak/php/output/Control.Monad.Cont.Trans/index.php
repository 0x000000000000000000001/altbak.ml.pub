...
$f1 = $__case_0;
$c = $__case_1;
return (function() use ($bind, $ask, $local, $f1, $c, $__global_Control_Monad_Cont_Trans_compose, $__global_Data_Function_const) {
  $__fn = function($k) use ($bind, $ask, $local, $f1, $c, $__global_Control_Monad_Cont_Trans_compose, $__global_Data_Function_const, &$__fn) {
  $__num = func_num_args();
  if ($__num < 1) {
    return phpurs_curry_fallback($__fn, func_get_args(), 1);
  }
    $__res = ($bind)($ask, (function() use ($local, $f1, $c, $__global_Control_Monad_Cont_Trans_compose, $__global_Data_Function_const, $k) {
  $__fn = function($r) use ($local, $f1, $c, $__global_Control_Monad_Cont_Trans_compose, $__global_Data_Function_const, $k, &$__fn) {
  $__num = func_num_args();
  if ($__num < 1) {
    return phpurs_curry_fallback($__fn, func_get_args(), 1);
  }
...
throw new \Exception("Pattern match failure");
  ...
  $__fn = function($f, $v = null) use ($bind, $ask, $local, $__global_Control_Monad_Cont_Trans_compose, $__global_Data_Function_const, $__body, &$__fn) {
  $__num = func_num_args();
  if ($__num < 2) {
    if ($__num === 1) return function($v) use ($f, &$__fn) { return $__fn($f, $v); };
    return phpurs_curry_fallback($__fn, func_get_args(), 2);
...
throw new \Exception("Pattern match failure");
  ...
  $__fn = function($f, $k = null) use ($__body, &$__fn) {
  $__num = func_num_args();
  if ($__num < 2) {
