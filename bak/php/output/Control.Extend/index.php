...
$Control_Extend_identity = ($Control_Category_identity)($Control_Category_categoryFn);
...
$Control_Extend_extendFn = (function() use (&$Data_Semigroup_append, &$Control_Extend_Extend__dollar__Dict, &$Data_Functor_functorFn) {
  $__fn = function($dictSemigroup) use (&$Data_Semigroup_append, &$Control_Extend_Extend__dollar__Dict, &$Data_Functor_functorFn, &$__fn) {
  $__num = func_num_args();
  if ($__num < 1) {
    $__args = func_get_args();
    return function(...$__more) use ($__args, &$__fn) {
...
$append = ($Data_Semigroup_append)($dictSemigroup);
    $__res = ($Control_Extend_Extend__dollar__Dict)((object)["extend" => (function() use ($append) {
...
$Control_Extend_extendArray = ($Control_Extend_Extend__dollar__Dict)((object)["extend" => $Control_Extend_arrayExtend, "Functor0" => (function() use (&$Data_Functor_functorArray) {
...
$Control_Extend_extendFlipped = (function() use (&$Control_Extend_extend) {
  $__fn = function($dictExtend) use (&$Control_Extend_extend, &$__fn) {
  $__num = func_num_args();
  if ($__num < 1) {
    $__args = func_get_args();
    return function(...$__more) use ($__args, &$__fn) {
...
$extend1 = ($Control_Extend_extend)($dictExtend);
...
$Control_Extend_duplicate = (function() use (&$Control_Extend_extend, &$Control_Extend_identity) {
  $__fn = function($dictExtend) use (&$Control_Extend_extend, &$Control_Extend_identity, &$__fn) {
  $__num = func_num_args();
  if ($__num < 1) {
    $__args = func_get_args();
    return function(...$__more) use ($__args, &$__fn) {
    ...
    $__res = ($Control_Extend_extend)($dictExtend, $Control_Extend_identity);
    if ($__num > 1) {
      $__args = func_get_args();
      return $__res(...array_slice($__args, 1));
    }
...
$Control_Extend_composeCoKleisliFlipped = (function() use (&$Control_Extend_extend) {
  $__fn = function($dictExtend) use (&$Control_Extend_extend, &$__fn) {
  $__num = func_num_args();
  if ($__num < 1) {
    $__args = func_get_args();
...
$Control_Extend_composeCoKleisli = (function() use (&$Control_Extend_extend) {
  $__fn = function($dictExtend) use (&$Control_Extend_extend, &$__fn) {
  $__num = func_num_args();
  if ($__num < 1) {
    $__args = func_get_args();
