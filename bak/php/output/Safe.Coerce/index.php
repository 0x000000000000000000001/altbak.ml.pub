...
// Safe_Coerce_coerce
function Safe_Coerce_coerce($__dollar____unused) {
  $__num = func_num_args();
  $__fn = __NAMESPACE__ . '\\' . 'Safe_Coerce_coerce';
  if ($__num < 1) {
...
$__global_Unsafe_Coerce_unsafeCoerce = ($GLOBALS['Unsafe_Coerce_unsafeCoerce'] ?? \Unsafe\Coerce\phpurs_eval_thunk('Unsafe_Coerce_unsafeCoerce'));
    $__res = $__global_Unsafe_Coerce_unsafeCoerce;
    return 1 < $__num ? $__res(...array_slice(func_get_args(), 1)) : $__res;
}
$GLOBALS['Safe_Coerce_coerce'] = __NAMESPACE__ . '\\Safe_Coerce_coerce';
