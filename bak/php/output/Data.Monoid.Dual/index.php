...
throw new \Exception("Pattern match failure");
  ...
  return $__fn;
      ...
      case 'Data_Monoid_Dual_eq1Dual': $v = (object)["eq1" => (function() {
  ...
  return $__fn;
      ...
      case 'Data_Monoid_Dual_ord1Dual': $v = (object)["compare1" => (function() {
...
$__global_Data_Monoid_Dual_applyDual = ($GLOBALS['Data_Monoid_Dual_applyDual'] ?? \Data\Monoid\Dual\phpurs_eval_thunk('Data_Monoid_Dual_applyDual'));
  ...
  return $__fn;
      ...
      case 'Data_Monoid_Dual_applicativeDual': $v = (object)["pure" => ($GLOBALS['Data_Monoid_Dual_Dual'] ?? \Data\Monoid\Dual\phpurs_eval_thunk('Data_Monoid_Dual_Dual')), "Apply0" => (function() {
  $__fn = function($__dollar____unused) use (&$__fn) {
  $__num = func_num_args();
  if ($__num < 1) {
    return phpurs_curry_fallback($__fn, func_get_args(), 1);
...
$__global_Data_Monoid_Dual_applyDual = ($GLOBALS['Data_Monoid_Dual_applyDual'] ?? \Data\Monoid\Dual\phpurs_eval_thunk('Data_Monoid_Dual_applyDual'));
  ...
  return $__fn;
      ...
      case 'Data_Monoid_Dual_monadDual': $v = (object)["Applicative0" => (function() {
  $__fn = function($__dollar____unused) use (&$__fn) {
  $__num = func_num_args();
  if ($__num < 1) {
    return phpurs_curry_fallback($__fn, func_get_args(), 1);
...
$semigroupDual1 = ($__global_Data_Monoid_Dual_semigroupDual)((($dictMonoid)->Semigroup0)($__global_Prim_undefined));
    $__res = (object)["mempty" => ($dictMonoid)->mempty, "Semigroup0" => (function() use ($semigroupDual1) {
