...
if (!function_exists(__NAMESPACE__ . '\\phpurs_eval_thunk')) {
  function phpurs_eval_thunk($id) {
    ...
    switch ($id) {
      case 'Data_Ring_Generic_genericRingNoArguments': $v = (object)["genericSub'" => (function() {
...
return ((function() {
  ...
  return $__fn;
})())(($genericSub__prime__1)($a1, $a2), ($genericSub__prime__2)($b1, $b2));
} else {
throw new \Exception("Pattern match failure");
};
  };
...
$a1 = $__case_0;
$a2 = $__case_1;
return ($genericSub__prime__1)($a1, $a2);
} else {
throw new \Exception("Pattern match failure");
};
  };
