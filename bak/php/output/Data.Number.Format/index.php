...
if (!function_exists(__NAMESPACE__ . '\\phpurs_eval_thunk')) {
  ...
  return $__fn;
      ...
      case 'Data_Number_Format_fixed': $v = (($GLOBALS['Data_Number_Format_compose'] ?? \Data\Number\Format\phpurs_eval_thunk('Data_Number_Format_compose')))((function() {
  $__fn = function($value0) use (&$__fn) {
  $__num = func_num_args();
  if ($__num < 1) {
    return phpurs_curry_fallback($__fn, func_get_args(), 1);
  ...
  return $__fn;
      ...
      case 'Data_Number_Format_exponential': $v = (($GLOBALS['Data_Number_Format_compose'] ?? \Data\Number\Format\phpurs_eval_thunk('Data_Number_Format_compose')))((function() {
  $__fn = function($value0) use (&$__fn) {
  $__num = func_num_args();
  if ($__num < 1) {
    return phpurs_curry_fallback($__fn, func_get_args(), 1);
...
case "Precision":
$p = ($__case_0)->v0;
return ($__global_Data_Number_Format_toPrecisionNative)($p);
break;
case "Fixed":
$p = ($__case_0)->v0;
return ($__global_Data_Number_Format_toFixedNative)($p);
break;
case "Exponential":
$p = ($__case_0)->v0;
return ($__global_Data_Number_Format_toExponentialNative)($p);
break;
default:
