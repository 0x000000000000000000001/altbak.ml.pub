...
$__global_Prim_undefined = ($GLOBALS['Prim_undefined'] ?? \Prim\phpurs_eval_thunk('Prim_undefined'));
  ...
  return $__fn;
      ...
      case 'Control_Monad_Maybe_Trans_monadTransMaybeT': $v = (object)["lift" => (function() {
...
$__global_Control_Monad_liftM1 = ($GLOBALS['Control_Monad_liftM1'] ?? \Control\Monad\phpurs_eval_thunk('Control_Monad_liftM1'));
    $__res = ($__global_Control_Monad_Maybe_Trans_compose)($__global_Control_Monad_Maybe_Trans_MaybeT, ($__global_Control_Monad_liftM1)($dictMonad, (function() {
...
while (true) {
return (object)["Applicative0" => (function() use ($__global_Control_Monad_Maybe_Trans_applicativeMaybeT, $dictMonad) {
  $__fn = function($__dollar____unused) use ($__global_Control_Monad_Maybe_Trans_applicativeMaybeT, $dictMonad, &$__fn) {
  $__num = func_num_args();
  if ($__num < 1) {
    return phpurs_curry_fallback($__fn, func_get_args(), 1);
  }
  ...
  return $__fn;
})(), "Bind1" => (function() use ($__global_Control_Monad_Maybe_Trans_bindMaybeT, $dictMonad) {
  $__fn = function($__dollar____unused) use ($__global_Control_Monad_Maybe_Trans_bindMaybeT, $dictMonad, &$__fn) {
  $__num = func_num_args();
  if ($__num < 1) {
    return phpurs_curry_fallback($__fn, func_get_args(), 1);
  }
...
throw new \Exception("Pattern match failure");
  ...
  return $__fn;
})(), "Apply0" => (function() use ($__global_Control_Monad_Maybe_Trans_applyMaybeT, $dictMonad) {
  $__fn = function($__dollar____unused) use ($__global_Control_Monad_Maybe_Trans_applyMaybeT, $dictMonad, &$__fn) {
  $__num = func_num_args();
  if ($__num < 1) {
    return phpurs_curry_fallback($__fn, func_get_args(), 1);
  }
...
return (object)["apply" => ($__global_Control_Monad_ap)(($__global_Control_Monad_Maybe_Trans_monadMaybeT)($dictMonad)), "Functor0" => (function() use ($functorMaybeT1) {
...
$__global_Control_Monad_Maybe_Trans_applyMaybeT = ($GLOBALS['Control_Monad_Maybe_Trans_applyMaybeT'] ?? \Control\Monad\Maybe\Trans\phpurs_eval_thunk('Control_Monad_Maybe_Trans_applyMaybeT'));
while (true) {
return (object)["pure" => ($__global_Control_Monad_Maybe_Trans_compose)($__global_Control_Monad_Maybe_Trans_MaybeT, ($__global_Control_Monad_Maybe_Trans_compose)(((($dictMonad)->Applicative0)($__global_Prim_undefined))->pure, (function() {
  $__fn = function($value0) use (&$__fn) {
  $__num = func_num_args();
  if ($__num < 1) {
    return phpurs_curry_fallback($__fn, func_get_args(), 1);
...
$monadMaybeT1 = ($__global_Control_Monad_Maybe_Trans_monadMaybeT)($Monad0);
    $__res = (object)["ask" => ($__global_Control_Monad_Maybe_Trans_lift)($Monad0, ($dictMonadAsk)->ask), "Monad0" => (function() use ($monadMaybeT1) {
...
$monadMaybeT1 = ($__global_Control_Monad_Maybe_Trans_monadMaybeT)($Monad0);
    $__res = (object)["liftEffect" => ($__global_Control_Monad_Maybe_Trans_compose)(($__global_Control_Monad_Maybe_Trans_lift)($Monad0), ($dictMonadEffect)->liftEffect), "Monad0" => (function() use ($monadMaybeT1) {
  $__fn = function($__dollar____unused) use ($monadMaybeT1, &$__fn) {
  $__num = func_num_args();
  if ($__num < 1) {
    return phpurs_curry_fallback($__fn, func_get_args(), 1);
...
$monadMaybeT1 = ($__global_Control_Monad_Maybe_Trans_monadMaybeT)($Monad1);
    $__res = (object)["tell" => ($__global_Control_Monad_Maybe_Trans_compose)(($__global_Control_Monad_Maybe_Trans_lift)($Monad1), ($dictMonadTell)->tell), "Semigroup0" => (function() use (&$Semigroup0) {
...
$monadMaybeT1 = ($__global_Control_Monad_Maybe_Trans_monadMaybeT)($Monad0);
    $__res = (object)["liftST" => ($__global_Control_Monad_Maybe_Trans_compose)(($__global_Control_Monad_Maybe_Trans_lift)($Monad0), ($dictMonadST)->liftST), "Monad0" => (function() use ($monadMaybeT1) {
  $__fn = function($__dollar____unused) use ($monadMaybeT1, &$__fn) {
  $__num = func_num_args();
  if ($__num < 1) {
    return phpurs_curry_fallback($__fn, func_get_args(), 1);
...
$semigroupMaybeT2 = ($semigroupMaybeT1)((($dictMonoid)->Semigroup0)($__global_Prim_undefined));
    $__res = (object)["mempty" => ($pure)(($dictMonoid)->mempty), "Semigroup0" => (function() use ($semigroupMaybeT2) {
...
$altMaybeT1 = ($__global_Control_Monad_Maybe_Trans_altMaybeT)($dictMonad);
    $__res = (object)["empty" => (((($dictMonad)->Applicative0)($__global_Prim_undefined))->pure)(($GLOBALS['__phpurs_data0_Nothing'] ??= new Phpurs_Data0("Nothing"))), "Alt0" => (function() use ($altMaybeT1) {
