...
$__global_Data_Date_Gen_genDate = ($GLOBALS['Data_Date_Gen_genDate'] ?? \Data\Date\Gen\phpurs_eval_thunk('Data_Date_Gen_genDate'));
$__global_Data_Time_Gen_genTime = ($GLOBALS['Data_Time_Gen_genTime'] ?? \Data\Time\Gen\phpurs_eval_thunk('Data_Time_Gen_genTime'));
$Apply0 = (((((($dictMonadGen)->Monad0)($__global_Prim_undefined))->Bind1)($__global_Prim_undefined))->Apply0)($__global_Prim_undefined);
    $__res = (($Apply0)->apply)((((($Apply0)->Functor0)($__global_Prim_undefined))->map)((function() {
  ...
  return $__fn;
})(), ($__global_Data_Date_Gen_genDate)($dictMonadGen)), ($__global_Data_Time_Gen_genTime)($dictMonadGen));
