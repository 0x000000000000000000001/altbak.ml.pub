...
throw new \Exception("Pattern match failure");
  ...
  return $__fn;
      ...
      case 'Data_Equivalence_newtypeEquivalence': $v = (object)["Coercible0" => (function() {
...
$__global_Prim_undefined = ($GLOBALS['Prim_undefined'] ?? \Prim\phpurs_eval_thunk('Prim_undefined'));
  ...
  return $__fn;
      ...
      case 'Data_Equivalence_monoidEquivalence': $v = (object)["mempty" => (function() {
...
$__global_Data_Equivalence_semigroupEquivalence = ($GLOBALS['Data_Equivalence_semigroupEquivalence'] ?? \Data\Equivalence\phpurs_eval_thunk('Data_Equivalence_semigroupEquivalence'));
  ...
  return $__fn;
      ...
      case 'Data_Equivalence_contravariantEquivalence': $v = (object)["cmap" => (function() {
  $__body = function($f, $v) {
...
function Data_Equivalence_comparisonEquivalence($v) {
  ...
  $__body = function($v) {
    ...
    if (true) {
$p = $__case_0;
return (function() use ($__global_Data_Equivalence_eq, $p) {
